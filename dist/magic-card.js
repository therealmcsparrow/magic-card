...
`;var an=function(e,t,o,i){var r,n=arguments.length,a=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,o,a):r(t,o))||a);return n>3&&a&&Object.defineProperty(t,o,a),a};let sn=class extends ue{constructor(){super(...arguments),this._searchQuery=""}render(){const e=this._searchQuery?xe.search(this._searchQuery):xe.getAll(),t=new Map;for(const i of o){const o=e.filter(e=>e.metadata.category===i).map(e=>e.metadata);o.length>0&&t.set(i,o)}return X`
  ...
  `,un([ve({type:String})],mn.prototype,"value",void 0),un([ve({type:String})],mn.prototype,"label",void 0),un([ve({type:String})],mn.prototype,"placeholder",void 0),mn=un([me("mc-unit-field")],mn);var fn=function(e,t,o,i){var r,n=arguments.length,a=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,o,a):r(t,o))||a);return n>3&&a&&Object.defineProperty(t,o,a),a};const gn={general:{label:"General",icon:"mdi:cog"},actions:{label:"Actions",icon:"mdi:gesture-tap"},logic:{label:"Conditions",icon:"mdi:filter-outline"},design:{label:"Design",icon:"mdi:palette"}};let vn=class extends ue{constructor(){super(...arguments),this.open=!1,this._activeTab="general"}setOnChange(e){this._onModuleChange=e}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){if(!this.open||!this.module)return X``;const e=xe.get(this.module.type);if(!e)return X``;const t=e.getAvailableTabs(),o=t.includes(this._activeTab)?this._activeTab:t[0];return X`
    ...
    `}_renderTabContent(e,t){if(!this.module||!this._onModuleChange)return X``;const o=this._onModuleChange;switch(e){case"general":return t.renderGeneralTab(this.module,this.hass,o);case"actions":return t.renderActionsTab?t.renderActionsTab(this.module,this.hass,o):X`<p>No actions available</p>`;case"logic":return t.renderLogicTab?t.renderLogicTab(this.module,this.hass,o):X`<p>No conditions available</p>`;case"design":return t.renderDesignTab?t.renderDesignTab(this.module,this.hass,o):X`<p>No design options</p>`}}};vn.styles=l`
    :host {
      display: block;
    }
  ...
  `,fn([ve({attribute:!1})],vn.prototype,"module",void 0),fn([ve({attribute:!1})],vn.prototype,"hass",void 0),fn([ve({type:Boolean})],vn.prototype,"open",void 0),fn([be()],vn.prototype,"_activeTab",void 0),vn=fn([me("mc-settings-modal")],vn);var bn=function(e,t,o,i){var r,n=arguments.length,a=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,o,a):r(t,o))||a);return n>3&&a&&Object.defineProperty(t,o,a),a};let yn=class extends ue{constructor(){super(...arguments),this._showModuleSelector=!1,this._showSettingsModal=!1,this._onAddModule=e=>{this._moduleSelectorTarget=e.detail,this._showModuleSelector=!0},this._onModuleSelected=e=>{this._moduleSelectorTarget&&this._stateManager.addModule(this._moduleSelectorTarget.rowIndex,this._moduleSelectorTarget.colIndex,e.detail.type),this._showModuleSelector=!1,this._moduleSelectorTarget=void 0}}connectedCallback(){super.connectedCallback(),this._stateManager=new Te(e=>{this.dispatchEvent(new CustomEvent("config-changed",{bubbles:!0,composed:!0,detail:{config:e}}))}),this._unsubscribe=this._stateManager.subscribe(e=>{this._editorState=e,void 0!==e.selectedPath?.moduleIndex&&(this._showSettingsModal=!0)}),this._pendingConfig&&(this._stateManager.setConfig(this._pendingConfig),this._pendingConfig=void 0)}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.(),this._stateManager?.destroy()}setConfig(e){this._stateManager?this._stateManager.setConfig(e):this._pendingConfig=e}render(){if(!this._editorState)return X`<div class="mc-editor">Loading...</div>`;const{editorMode:e}=this._editorState;return X`
    ...
    `}_renderEditorMode(e){switch(e){case"form":return X`
      ...
      <mc-settings-modal
        ...
        .setOnChange=${e=>{}}
      ></mc-settings-modal>
    `}_getSettingsModal(){return this.shadowRoot?.querySelector("mc-settings-modal")??null}updated(){const e=this._getSettingsModal();if(e&&this._editorState?.selectedPath){const{selectedPath:t}=this._editorState;e.setOnChange(e=>{void 0!==t?.rowIndex&&void 0!==t?.columnIndex&&void 0!==t?.moduleIndex&&this._stateManager.updateModule(t.rowIndex,t.columnIndex,t.moduleIndex,e)})}}_renderModuleSelectorDialog(){return X`
      <mc-module-selector
    ...
    `}renderLogicTab(e,t,o){const i=e.display,r=i?.conditions||[],n=t=>{o({...e,display:{...i,...t}})},a=(e,t)=>{n({conditions:r.map(o=>o.id===e?{...o,...t}:o)})};return X`
      <div class="mc-tab-content">
        ...
        <button class="mc-btn mc-btn-secondary" @click=${()=>{const e={id:Se("cond"),type:"state",entity:"",state:""};n({conditions:[...r,e]})}}>
    ...
    `}}xe.register(new class extends xn{constructor(){super(...arguments),this.metadata={type:"text",name:"Text",description:"Display static or template text",category:"content",icon:"mdi:format-text"}}createDefault(){return{id:Se("text"),type:"text",text:"Hello World"}}renderPreview(e,t){return X`<div class="mc-module mc-text">${e.text||""}</div>`}renderGeneralTab(e,t,o){const i=e;return X`
      <div class="mc-tab-content">
    ...
    `}});xe.register(new class extends xn{constructor(){super(...arguments),this.metadata={type:"info",name:"Info",description:"Display entity name, state, and attributes",category:"content",icon:"mdi:information-outline"}}createDefault(){return{id:Se("info"),type:"info",show_name:!0,show_state:!0,show_unit:!0}}renderPreview(e,t){const o=e,i=o.entity&&t?t.states[o.entity]:void 0,r=i?.attributes.friendly_name||o.entity||"No entity",n=i?t.formatEntityState(i):"—";return X`
    ...
    `}validate(e){const t=[],o=e;return o.image||o.entity_picture||t.push("An image URL or entity picture source is required"),o.entity_picture&&!o.entity&&t.push("Entity is required when using entity picture"),t}});xe.register(new class extends xn{constructor(){super(...arguments),this.metadata={type:"markdown",name:"Markdown",description:"Render markdown-formatted content",category:"content",icon:"mdi:language-markdown"}}createDefault(){return{id:Se("markdown"),type:"markdown",content:"**Hello** _World_"}}renderPreview(e,t){const o=(e.content||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/__(.+?)__/g,"<strong>$1</strong>").replace(/\*(.+?)\*/g,"<em>$1</em>").replace(/_(.+?)_/g,"<em>$1</em>").replace(/`(.+?)`/g,"<code>$1</code>").replace(/\n/g,"<br>");return X`
    ...
    `}validate(e){const t=[];return e.content||t.push("Markdown content is required"),t}});xe.register(new class extends xn{constructor(){super(...arguments),this.metadata={type:"bar",name:"Bar",description:"Display a progress bar based on entity state",category:"content",icon:"mdi:chart-bar"}}createDefault(){return{id:Se("bar"),type:"bar",min:0,max:100,bar_height:"8px",bar_color:"var(--primary-color, #03a9f4)",bar_background:"var(--divider-color, #e0e0e0)",show_value:!0,direction:"horizontal"}}renderPreview(e,t){const o=e,i=o.min??0,r=o.max??100,n=o.entity&&t?t.states[o.entity]:void 0,a=n?parseFloat(n.state):i,s=Math.min(Math.max(a,i),r),l=r!==i?(s-i)/(r-i)*100:0;let c=o.bar_color||"var(--primary-color, #03a9f4)";if(o.severity&&o.severity.length>0)for(const e of o.severity)if(s>=e.from&&s<=e.to){c=e.color;break}const d=o.bar_background||"var(--divider-color, #e0e0e0)",p=o.bar_height||"8px";return"vertical"===o.direction?X`
    ...
    `}});xe.register(new class extends xn{constructor(){super(...arguments),this.metadata={type:"camera",name:"Camera",description:"Display a camera entity stream",category:"content",icon:"mdi:cctv"}}createDefault(){return{id:Se("camera"),type:"camera",aspect_ratio:"16:9",show_controls:!0}}renderPreview(e,t){const o=e,i=o.entity&&t?t.states[o.entity]:void 0,r=i?.attributes.entity_picture,n=i?.attributes.friendly_name||o.entity||"No camera";return X`
    ...
    `}});xe.register(new class extends xn{constructor(){super(...arguments),this.metadata={type:"button",name:"Button",description:"Interactive button with icon, label, and optional state display",category:"controls",icon:"mdi:gesture-tap"}}createDefault(){return{id:Se("button"),type:"button",label:"Button",icon:"mdi:power",show_state:!1,button_style:"default"}}renderPreview(e,t){const o=e,i=o.entity&&t?t.states[o.entity]:void 0,r=i?t.formatEntityState(i):void 0,n=o.label||"Button",a="icon-only"===o.button_style;return X`
    ...
    `}});xe.register(new class extends xn{constructor(){super(...arguments),this.metadata={type:"slider",name:"Slider",description:"Range slider for controlling numeric values",category:"controls",icon:"mdi:tune-vertical"}}createDefault(){return{id:Se("slider"),type:"slider",min:0,max:100,step:1,show_value:!0,direction:"horizontal"}}renderPreview(e,t){const o=e,i=o.entity&&t?t.states[o.entity]:void 0,r=o.min??0,n=o.max??100,a=o.step??1,s=i?o.attribute?Number(i.attributes[o.attribute]??r):Number(i.state):Math.round((r+n)/2),l="vertical"===o.direction;return X`
      <div
    ...
    `}});xe.register(new class extends xn{constructor(){super(...arguments),this.metadata={type:"dropdown",name:"Dropdown",description:"Select dropdown for choosing from a list of options",category:"controls",icon:"mdi:form-dropdown"}}createDefault(){return{id:Se("dropdown"),type:"dropdown",options:[{label:"Option 1",value:"option_1"},{label:"Option 2",value:"option_2"},{label:"Option 3",value:"option_3"}]}}renderPreview(e,t){const o=e,i=o.entity&&t?t.states[o.entity]:void 0,r=i?o.attribute?String(i.attributes[o.attribute]??""):i.state:void 0,n=o.options||[];return X`
    ...
    `}validate(e){const t=[];return e.entity||t.push("Entity is required for light module"),t}});xe.register(new class extends xn{constructor(){super(...arguments),this.metadata={type:"gauge",name:"Gauge",description:"Arc gauge for displaying numeric sensor values",category:"controls",icon:"mdi:gauge"}}createDefault(){return{id:Se("gauge"),type:"gauge",min:0,max:100,needle:!0,gauge_style:"half"}}renderPreview(e,t){const o=e,i=o.entity&&t?t.states[o.entity]:void 0,r=o.min??0,n=o.max??100,a=i?Number(i.state):Math.round((r+n)/2),s=Math.max(r,Math.min(n,a)),l=(s-r)/(n-r)*100,c=this._getSeverityColor(s,o.severity)||"var(--primary-color, #03a9f4)",d=("half"===o.gauge_style||o.gauge_style,"full"===o.gauge_style),p="quarter"===o.gauge_style;if(d){const e=l/100*360,t=(e-90)*(Math.PI/180),o=40,i=50,r=50+o*Math.cos(t),n=i+o*Math.sin(t);return X`
    ...
    `}_getSeverityColor(e,t){if(t&&0!==t.length)for(const o of t)if(e>=o.from&&e<=o.to)return o.color}});xe.register(new class extends xn{constructor(){super(...arguments),this.metadata={type:"horizontal",name:"Horizontal",description:"Arrange child modules in a row",category:"layout",icon:"mdi:arrow-split-vertical"}}createDefault(){return{id:Se("horizontal"),type:"horizontal",modules:[],gap:"8px",align:"center",justify:"start"}}renderPreview(e,t){const o=e,i=o.modules||[];return X`
    ...
    `}});xe.register(new class extends xn{constructor(){super(...arguments),this.metadata={type:"vertical",name:"Vertical",description:"Arrange child modules in a column",category:"layout",icon:"mdi:arrow-split-horizontal"}}createDefault(){return{id:Se("vertical"),type:"vertical",modules:[],gap:"8px",align:"stretch"}}renderPreview(e,t){const o=e,i=o.modules||[];return X`
    ...
    `}});xe.register(new class extends xn{constructor(){super(...arguments),this.metadata={type:"tabs",name:"Tabs",description:"Tabbed container for groups of modules",category:"layout",icon:"mdi:tab"}}createDefault(){return{id:Se("tabs"),type:"tabs",tabs:[{label:"Tab 1",modules:[]},{label:"Tab 2",modules:[]}],active_tab:0,tab_style:"default"}}renderPreview(e,t){const o=e,i=o.tabs||[],r=o.active_tab||0,n=i[r];return X`
    ...
    `}});xe.register(new class extends xn{constructor(){super(...arguments),this.metadata={type:"separator",name:"Separator",description:"Visual divider between modules",category:"layout",icon:"mdi:minus"}}getAvailableTabs(){return["general","logic","design"]}createDefault(){return{id:Se("separator"),type:"separator",separator_style:"solid",separator_color:"var(--divider-color, #e5e7eb)",separator_width:"1px",direction:"horizontal"}}renderPreview(e,t){const o=e;return"vertical"===o.direction?X`
    ...
    `}});xe.register(new class extends xn{constructor(){super(...arguments),this.metadata={type:"clock",name:"Clock",description:"Display current time and date",category:"advanced",icon:"mdi:clock-outline"}}getAvailableTabs(){return["general","logic","design"]}createDefault(){return{id:Se("clock"),type:"clock",format_12h:!1,show_seconds:!1,show_date:!0,date_format:"short"}}renderPreview(e,t){const o=e,i=new Date,r={hour:"2-digit",minute:"2-digit",hour12:o.format_12h??!1};o.show_seconds&&(r.second="2-digit");const n=i.toLocaleTimeString(void 0,r),a=o.show_date?i.toLocaleDateString(void 0,{weekday:"short",month:"short",day:"numeric"}):"";return X`
    ...
    `}});xe.register(new class extends xn{constructor(){super(...arguments),this.metadata={type:"weather",name:"Weather",description:"Display weather entity information",category:"advanced",icon:"mdi:weather-partly-cloudy"}}createDefault(){return{id:Se("weather"),type:"weather",show_temperature:!0,show_condition:!0,show_forecast:!1,forecast_days:5}}renderPreview(e,t){const o=e,i=o.entity&&t?t.states[o.entity]:void 0,r=i?.attributes.temperature,n=i?.state||"unknown",a=i?.attributes.temperature_unit||"°C",s=this._conditionIcon(n);return X`
    ...
    `}});xe.register(new class extends xn{constructor(){super(...arguments),this.metadata={type:"video-bg",name:"Video Background",description:"Display a video as a background",category:"advanced",icon:"mdi:video-outline"}}getAvailableTabs(){return["general","logic","design"]}createDefault(){return{id:Se("video-bg"),type:"video-bg",autoplay:!0,loop:!0,muted:!0}}renderPreview(e,t){const o=e;return o.url?X`
