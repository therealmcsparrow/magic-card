...
`;function ze(e){if(null===e||"object"!=typeof e)return e;if(Array.isArray(e))return e.map(e=>ze(e));const t={};for(const r of Object.keys(e))t[r]=ze(e[r]);return t}class Ee{constructor(e=50){this.undoStack=[],this.redoStack=[],this.limit=e}push(e){this.undoStack.push(ze(e)),this.undoStack.length>this.limit&&this.undoStack.shift(),this.redoStack=[]}undo(e){return 0===this.undoStack.length?null:(this.redoStack.push(ze(e)),this.undoStack.pop())}redo(e){return 0===this.redoStack.length?null:(this.undoStack.push(ze(e)),this.redoStack.pop())}canUndo(){return this.undoStack.length>0}canRedo(){return this.redoStack.length>0}clear(){this.undoStack=[],this.redoStack=[]}get undoCount(){return this.undoStack.length}get redoCount(){return this.redoStack.length}}class Te{constructor(e){this.fireEvent=e,this.undoRedo=new Ee,this.listeners=new Set,this.state={config:{type:"custom:magic-card",rows:[]},selectedPath:null,activeTab:"general",editorMode:"form",isDirty:!1},this.dispatchConfigChanged=function(e,t){let r=null;const i=function(...i){null!==r&&clearTimeout(r),r=setTimeout(()=>{e.apply(this,i),r=null},t)};return i.cancel=()=>{null!==r&&(clearTimeout(r),r=null)},i}(e=>{this.fireEvent(e)},200)}subscribe(e){return this.listeners.add(e),e(this.state),()=>this.listeners.delete(e)}notify(){this.listeners.forEach(e=>e(this.state))}getState(){return this.state}getConfig(){return this.state.config}getSelectedModule(){const e=this.state.selectedPath;return void 0===e?.rowIndex||void 0===e?.columnIndex||void 0===e?.moduleIndex?null:this.state.config.rows[e.rowIndex]?.columns[e.columnIndex]?.modules[e.moduleIndex]??null}setConfig(e){this.state={...this.state,config:ze(e),isDirty:!1},this.notify()}updateConfig(e,t=!0){t&&this.undoRedo.push(this.state.config),this.state={...this.state,config:ze(e),isDirty:!0},this.notify(),this.dispatchConfigChanged(this.state.config)}setEditorMode(e){this.state={...this.state,editorMode:e},this.notify()}setSelectedPath(e){this.state={...this.state,selectedPath:e},this.notify()}setActiveTab(e){this.state={...this.state,activeTab:e},this.notify()}addRow(e="1"){const t=ze(this.state.config),r=e.split("-").length,i=Array.from({length:r},()=>({id:Ce("col"),modules:[]}));t.rows.push({id:Ce("row"),layout:e,columns:i}),this.updateConfig(t)}deleteRow(e){const t=ze(this.state.config);t.rows.splice(e,1),this.state.selectedPath=null,this.updateConfig(t)}moveRow(e,t){if(e===t)return;const r=ze(this.state.config),[i]=r.rows.splice(e,1);r.rows.splice(t,0,i),this.updateConfig(r)}updateRow(e,t){const r=ze(this.state.config);r.rows[e]={...r.rows[e],...t},this.updateConfig(r)}addColumn(e){const t=ze(this.state.config);t.rows[e].columns.push({id:Ce("col"),modules:[]}),this.updateConfig(t)}deleteColumn(e,t){const r=ze(this.state.config);r.rows[e].columns.splice(t,1),0===r.rows[e].columns.length&&r.rows.splice(e,1),this.state.selectedPath=null,this.updateConfig(r)}addModule(e,t,r){const i=ze(this.state.config),o=_e.createDefault(r);if(!o)return;i.rows[e].columns[t].modules.push(o);const n=i.rows[e].columns[t].modules.length-1;this.updateConfig(i),this.setSelectedPath({rowIndex:e,columnIndex:t,moduleIndex:n})}deleteModule(e,t,r){const i=ze(this.state.config);i.rows[e].columns[t].modules.splice(r,1),this.state.selectedPath=null,this.updateConfig(i)}updateModule(e,t,r,i){const o=ze(this.state.config),n=o.rows[e].columns[t].modules[r];o.rows[e].columns[t].modules[r]={...n,...i},this.updateConfig(o)}moveModule(e,t,r,i,o,n){const a=ze(this.state.config),[s]=a.rows[e].columns[t].modules.splice(r,1);a.rows[i].columns[o].modules.splice(n,0,s),this.updateConfig(a),this.setSelectedPath({rowIndex:i,columnIndex:o,moduleIndex:n})}undo(){const e=this.undoRedo.undo(this.state.config);e&&(this.state={...this.state,config:e,isDirty:!0},this.notify(),this.dispatchConfigChanged(e))}redo(){const e=this.undoRedo.redo(this.state.config);e&&(this.state={...this.state,config:e,isDirty:!0},this.notify(),this.dispatchConfigChanged(e))}canUndo(){return this.undoRedo.canUndo()}canRedo(){return this.undoRedo.canRedo()}destroy(){this.dispatchConfigChanged.cancel(),this.listeners.clear(),this.undoRedo.clear()}}const Ie=c`
  :host {
    display: block;
  }
