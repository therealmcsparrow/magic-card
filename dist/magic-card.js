...
`;function Re(e){if(null===e||"object"!=typeof e)return e;if(Array.isArray(e))return e.map(e=>Re(e));const t={};for(const i of Object.keys(e))t[i]=Re(e[i]);return t}class Ne{constructor(e=50){this.undoStack=[],this.redoStack=[],this.limit=e}push(e){this.undoStack.push(Re(e)),this.undoStack.length>this.limit&&this.undoStack.shift(),this.redoStack=[]}undo(e){return 0===this.undoStack.length?null:(this.redoStack.push(Re(e)),this.undoStack.pop())}redo(e){return 0===this.redoStack.length?null:(this.undoStack.push(Re(e)),this.redoStack.pop())}canUndo(){return this.undoStack.length>0}canRedo(){return this.redoStack.length>0}clear(){this.undoStack=[],this.redoStack=[]}get undoCount(){return this.undoStack.length}get redoCount(){return this.redoStack.length}}class Le{constructor(e){this.fireEvent=e,this.undoRedo=new Ne,this.listeners=new Set,this.state={config:{type:"custom:magic-card",rows:[]},selectedPath:null,activeTab:"general",editorMode:"form",isDirty:!1},this.dispatchConfigChanged=function(e,t){let i=null;const r=function(...r){null!==i&&clearTimeout(i),i=setTimeout(()=>{e.apply(this,r),i=null},t)};return r.cancel=()=>{null!==i&&(clearTimeout(i),i=null)},r}(e=>{this.fireEvent(e)},200)}subscribe(e){return this.listeners.add(e),e(this.state),()=>this.listeners.delete(e)}notify(){this.listeners.forEach(e=>e(this.state))}getState(){return this.state}getConfig(){return this.state.config}getSelectedModule(){const e=this.state.selectedPath;return void 0===e?.rowIndex||void 0===e?.columnIndex||void 0===e?.moduleIndex?null:this.state.config.rows[e.rowIndex]?.columns[e.columnIndex]?.modules[e.moduleIndex]??null}setConfig(e){this.state={...this.state,config:Re(e),isDirty:!1},this.notify()}updateConfig(e,t=!0){t&&this.undoRedo.push(this.state.config),this.state={...this.state,config:Re(e),isDirty:!0},this.notify(),this.dispatchConfigChanged(this.state.config)}setEditorMode(e){this.state={...this.state,editorMode:e},this.notify()}setSelectedPath(e){this.state={...this.state,selectedPath:e},this.notify()}setActiveTab(e){this.state={...this.state,activeTab:e},this.notify()}addRow(e="1"){const t=Re(this.state.config),i=e.split("-").length,r=Array.from({length:i},()=>({id:Ce("col"),modules:[]}));t.rows.push({id:Ce("row"),layout:e,columns:r}),this.updateConfig(t)}deleteRow(e){const t=Re(this.state.config);t.rows.splice(e,1),this.state.selectedPath=null,this.updateConfig(t)}moveRow(e,t){if(e===t)return;const i=Re(this.state.config),[r]=i.rows.splice(e,1);i.rows.splice(t,0,r),this.updateConfig(i)}updateRow(e,t){const i=Re(this.state.config);i.rows[e]={...i.rows[e],...t},this.updateConfig(i)}addColumn(e){const t=Re(this.state.config);t.rows[e].columns.push({id:Ce("col"),modules:[]}),this.updateConfig(t)}deleteColumn(e,t){const i=Re(this.state.config);i.rows[e].columns.splice(t,1),0===i.rows[e].columns.length&&i.rows.splice(e,1),this.state.selectedPath=null,this.updateConfig(i)}addModule(e,t,i){const r=Re(this.state.config),o=_e.createDefault(i);if(!o)return;r.rows[e].columns[t].modules.push(o);const n=r.rows[e].columns[t].modules.length-1;this.updateConfig(r),this.setSelectedPath({rowIndex:e,columnIndex:t,moduleIndex:n})}deleteModule(e,t,i){const r=Re(this.state.config);r.rows[e].columns[t].modules.splice(i,1),this.state.selectedPath=null,this.updateConfig(r)}updateModule(e,t,i,r){const o=Re(this.state.config),n=o.rows[e].columns[t].modules[i];o.rows[e].columns[t].modules[i]={...n,...r},this.updateConfig(o)}moveModule(e,t,i,r,o,n){const a=Re(this.state.config),[s]=a.rows[e].columns[t].modules.splice(i,1);a.rows[r].columns[o].modules.splice(n,0,s),this.updateConfig(a),this.setSelectedPath({rowIndex:r,columnIndex:o,moduleIndex:n})}undo(){const e=this.undoRedo.undo(this.state.config);e&&(this.state={...this.state,config:e,isDirty:!0},this.notify(),this.dispatchConfigChanged(e))}redo(){const e=this.undoRedo.redo(this.state.config);e&&(this.state={...this.state,config:e,isDirty:!0},this.notify(),this.dispatchConfigChanged(e))}canUndo(){return this.undoRedo.canUndo()}canRedo(){return this.undoRedo.canRedo()}destroy(){this.dispatchConfigChanged.cancel(),this.listeners.clear(),this.undoRedo.clear()}}const He=c`
  :host {
    display: block;
  }
...
`;var Ue=function(e,t,i,r){var o,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let Fe=class extends he{constructor(){super(...arguments),this._collapsedRows=new Set,this._dragOver=null,this._dragState=null}connectedCallback(){super.connectedCallback(),this.stateManager&&(this._unsubscribe=this.stateManager.subscribe(e=>{this._editorState=e}))}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.()}_onRowDragStart(e,t){this._dragState={type:"row",rowIndex:t},e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",JSON.stringify(this._dragState)),e.target.classList.add("dragging")}_onRowDragEnd(e){e.target.classList.remove("dragging"),this._dragState=null,this._dragOver=null}_onRowDragOver(e,t){this._dragState&&"row"===this._dragState.type&&(e.preventDefault(),e.dataTransfer.dropEffect="move",this._dragOver={type:"row",index:t})}_onRowDragLeave(){this._dragOver=null}_onRowDrop(e,t){if(e.preventDefault(),!this._dragState||"row"!==this._dragState.type)return;const i=this._dragState.rowIndex;i!==t&&this.stateManager.moveRow(i,t),this._dragState=null,this._dragOver=null}_onModuleDragStart(e,t,i,r){this._dragState={type:"module",rowIndex:t,colIndex:i,moduleIndex:r},e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",JSON.stringify(this._dragState)),e.target.classList.add("dragging"),e.stopPropagation()}_onModuleDragEnd(e){e.target.classList.remove("dragging"),this._dragState=null,this._dragOver=null}_onModuleDragOver(e,t,i,r){this._dragState&&"module"===this._dragState.type&&(e.preventDefault(),e.stopPropagation(),e.dataTransfer.dropEffect="move",this._dragOver={type:"module",index:r,colIndex:i})}_onContainerDragOver(e,t,i){this._dragState&&"module"===this._dragState.type&&(e.preventDefault(),e.dataTransfer.dropEffect="move")}_onModuleDrop(e,t,i,r){if(e.preventDefault(),e.stopPropagation(),!this._dragState||"module"!==this._dragState.type)return;const{rowIndex:o,colIndex:n,moduleIndex:a}=this._dragState;o===t&&n===i&&a===r||this.stateManager.moveModule(o,n,a,t,i,r),this._dragState=null,this._dragOver=null}_onContainerDrop(e,t,i){if(e.preventDefault(),!this._dragState||"module"!==this._dragState.type)return;const{rowIndex:r,colIndex:o,moduleIndex:n}=this._dragState,a=(this._editorState?.config.rows[t]?.columns[i]?.modules||[]).length;this.stateManager.moveModule(r,o,n,t,i,a),this._dragState=null,this._dragOver=null}render(){if(!this._editorState)return Y``;const{config:e,selectedPath:t}=this._editorState;return Y`
    ...
    `}_toggleRow(e){this._collapsedRows.has(e)?this._collapsedRows.delete(e):this._collapsedRows.add(e),this.requestUpdate()}};function Be(e){return null==e}Fe.styles=[De,He],Ue([be({attribute:!1})],Fe.prototype,"stateManager",void 0),Ue([be({attribute:!1})],Fe.prototype,"hass",void 0),Ue([ye()],Fe.prototype,"_editorState",void 0),Ue([ye()],Fe.prototype,"_collapsedRows",void 0),Ue([ye()],Fe.prototype,"_dragOver",void 0),Fe=Ue([ge("mc-form-editor")],Fe);var Ge={isNothing:Be,isObject:function(e){return"object"==typeof e&&null!==e},toArray:function(e){return Array.isArray(e)?e:Be(e)?[]:[e]},repeat:function(e,t){var i,r="";for(i=0;i<t;i+=1)r+=e;return r},isNegativeZero:function(e){return 0===e&&Number.NEGATIVE_INFINITY===1/e},extend:function(e,t){var i,r,o,n;if(t)for(i=0,r=(n=Object.keys(t)).length;i<r;i+=1)e[o=n[i]]=t[o];return e}};function qe(e,t){var i="",r=e.reason||"(unknown reason)";return e.mark?(e.mark.name&&(i+='in "'+e.mark.name+'" '),i+="("+(e.mark.line+1)+":"+(e.mark.column+1)+")",!t&&e.mark.snippet&&(i+="\n\n"+e.mark.snippet),r+" "+i):r}function Qe(e,t){Error.call(this),this.name="YAMLException",this.reason=e,this.mark=t,this.message=qe(this,!1),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=(new Error).stack||""}Qe.prototype=Object.create(Error.prototype),Qe.prototype.constructor=Qe,Qe.prototype.toString=function(e){return this.name+": "+qe(this,e)};var We=Qe;function Ye(e,t,i,r,o){var n="",a="",s=Math.floor(o/2)-1;return r-t>s&&(t=r-s+(n=" ... ").length),i-r>s&&(i=r+s-(a=" ...").length),{str:n+e.slice(t,i).replace(/\t/g,"→")+a,pos:r-t+n.length}}function Ve(e,t){return Ge.repeat(" ",t-e.length)+e}var Ke=function(e,t){if(t=Object.create(t||null),!e.buffer)return null;t.maxLength||(t.maxLength=79),"number"!=typeof t.indent&&(t.indent=1),"number"!=typeof t.linesBefore&&(t.linesBefore=3),"number"!=typeof t.linesAfter&&(t.linesAfter=2);for(var i,r=/\r?\n|\r|\0/g,o=[0],n=[],a=-1;i=r.exec(e.buffer);)n.push(i.index),o.push(i.index+i[0].length),e.position<=i.index&&a<0&&(a=o.length-2);a<0&&(a=o.length-1);var s,c,l="",d=Math.min(e.line+t.linesAfter,n.length).toString().length,p=t.maxLength-(t.indent+d+3);for(s=1;s<=t.linesBefore&&!(a-s<0);s++)c=Ye(e.buffer,o[a-s],n[a-s],e.position-(o[a]-o[a-s]),p),l=Ge.repeat(" ",t.indent)+Ve((e.line-s+1).toString(),d)+" | "+c.str+"\n"+l;for(c=Ye(e.buffer,o[a],n[a],e.position,p),l+=Ge.repeat(" ",t.indent)+Ve((e.line+1).toString(),d)+" | "+c.str+"\n",l+=Ge.repeat("-",t.indent+d+3+c.pos)+"^\n",s=1;s<=t.linesAfter&&!(a+s>=n.length);s++)c=Ye(e.buffer,o[a+s],n[a+s],e.position-(o[a]-o[a+s]),p),l+=Ge.repeat(" ",t.indent)+Ve((e.line+s+1).toString(),d)+" | "+c.str+"\n";return l.replace(/\n$/,"")},Je=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],Ze=["scalar","sequence","mapping"];var Xe=function(e,t){if(t=t||{},Object.keys(t).forEach(function(t){if(-1===Je.indexOf(t))throw new We('Unknown option "'+t+'" is met in definition of "'+e+'" YAML type.')}),this.options=t,this.tag=e,this.kind=t.kind||null,this.resolve=t.resolve||function(){return!0},this.construct=t.construct||function(e){return e},this.instanceOf=t.instanceOf||null,this.predicate=t.predicate||null,this.represent=t.represent||null,this.representName=t.representName||null,this.defaultStyle=t.defaultStyle||null,this.multi=t.multi||!1,this.styleAliases=function(e){var t={};return null!==e&&Object.keys(e).forEach(function(i){e[i].forEach(function(e){t[String(e)]=i})}),t}(t.styleAliases||null),-1===Ze.indexOf(this.kind))throw new We('Unknown kind "'+this.kind+'" is specified for "'+e+'" YAML type.')};function et(e,t){var i=[];return e[t].forEach(function(e){var t=i.length;i.forEach(function(i,r){i.tag===e.tag&&i.kind===e.kind&&i.multi===e.multi&&(t=r)}),i[t]=e}),i}function tt(e){return this.extend(e)}tt.prototype.extend=function(e){var t=[],i=[];if(e instanceof Xe)i.push(e);else if(Array.isArray(e))i=i.concat(e);else{if(!e||!Array.isArray(e.implicit)&&!Array.isArray(e.explicit))throw new We("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");e.implicit&&(t=t.concat(e.implicit)),e.explicit&&(i=i.concat(e.explicit))}t.forEach(function(e){if(!(e instanceof Xe))throw new We("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(e.loadKind&&"scalar"!==e.loadKind)throw new We("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(e.multi)throw new We("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),i.forEach(function(e){if(!(e instanceof Xe))throw new We("Specified list of YAML types (or a single Type object) contains a non-Type object.")});var r=Object.create(tt.prototype);return r.implicit=(this.implicit||[]).concat(t),r.explicit=(this.explicit||[]).concat(i),r.compiledImplicit=et(r,"implicit"),r.compiledExplicit=et(r,"explicit"),r.compiledTypeMap=function(){var e,t,i={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}};function r(e){e.multi?(i.multi[e.kind].push(e),i.multi.fallback.push(e)):i[e.kind][e.tag]=i.fallback[e.tag]=e}for(e=0,t=arguments.length;e<t;e+=1)arguments[e].forEach(r);return i}(r.compiledImplicit,r.compiledExplicit),r};var it=tt,rt=new Xe("tag:yaml.org,2002:str",{kind:"scalar",construct:function(e){return null!==e?e:""}}),ot=new Xe("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(e){return null!==e?e:[]}}),nt=new Xe("tag:yaml.org,2002:map",{kind:"mapping",construct:function(e){return null!==e?e:{}}}),at=new it({explicit:[rt,ot,nt]});var st=new Xe("tag:yaml.org,2002:null",{kind:"scalar",resolve:function(e){if(null===e)return!0;var t=e.length;return 1===t&&"~"===e||4===t&&("null"===e||"Null"===e||"NULL"===e)},construct:function(){return null},predicate:function(e){return null===e},represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"});var ct=new Xe("tag:yaml.org,2002:bool",{kind:"scalar",resolve:function(e){if(null===e)return!1;var t=e.length;return 4===t&&("true"===e||"True"===e||"TRUE"===e)||5===t&&("false"===e||"False"===e||"FALSE"===e)},construct:function(e){return"true"===e||"True"===e||"TRUE"===e},predicate:function(e){return"[object Boolean]"===Object.prototype.toString.call(e)},represent:{lowercase:function(e){return e?"true":"false"},uppercase:function(e){return e?"TRUE":"FALSE"},camelcase:function(e){return e?"True":"False"}},defaultStyle:"lowercase"});function lt(e){return 48<=e&&e<=57||65<=e&&e<=70||97<=e&&e<=102}function dt(e){return 48<=e&&e<=55}function pt(e){return 48<=e&&e<=57}var ut=new Xe("tag:yaml.org,2002:int",{kind:"scalar",resolve:function(e){if(null===e)return!1;var t,i=e.length,r=0,o=!1;if(!i)return!1;if("-"!==(t=e[r])&&"+"!==t||(t=e[++r]),"0"===t){if(r+1===i)return!0;if("b"===(t=e[++r])){for(r++;r<i;r++)if("_"!==(t=e[r])){if("0"!==t&&"1"!==t)return!1;o=!0}return o&&"_"!==t}if("x"===t){for(r++;r<i;r++)if("_"!==(t=e[r])){if(!lt(e.charCodeAt(r)))return!1;o=!0}return o&&"_"!==t}if("o"===t){for(r++;r<i;r++)if("_"!==(t=e[r])){if(!dt(e.charCodeAt(r)))return!1;o=!0}return o&&"_"!==t}}if("_"===t)return!1;for(;r<i;r++)if("_"!==(t=e[r])){if(!pt(e.charCodeAt(r)))return!1;o=!0}return!(!o||"_"===t)},construct:function(e){var t,i=e,r=1;if(-1!==i.indexOf("_")&&(i=i.replace(/_/g,"")),"-"!==(t=i[0])&&"+"!==t||("-"===t&&(r=-1),t=(i=i.slice(1))[0]),"0"===i)return 0;if("0"===t){if("b"===i[1])return r*parseInt(i.slice(2),2);if("x"===i[1])return r*parseInt(i.slice(2),16);if("o"===i[1])return r*parseInt(i.slice(2),8)}return r*parseInt(i,10)},predicate:function(e){return"[object Number]"===Object.prototype.toString.call(e)&&e%1==0&&!Ge.isNegativeZero(e)},represent:{binary:function(e){return e>=0?"0b"+e.toString(2):"-0b"+e.toString(2).slice(1)},octal:function(e){return e>=0?"0o"+e.toString(8):"-0o"+e.toString(8).slice(1)},decimal:function(e){return e.toString(10)},hexadecimal:function(e){return e>=0?"0x"+e.toString(16).toUpperCase():"-0x"+e.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),ht=new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");var mt=/^[-+]?[0-9]+e/;var gt=new Xe("tag:yaml.org,2002:float",{kind:"scalar",resolve:function(e){return null!==e&&!(!ht.test(e)||"_"===e[e.length-1])},construct:function(e){var t,i;return i="-"===(t=e.replace(/_/g,"").toLowerCase())[0]?-1:1,"+-".indexOf(t[0])>=0&&(t=t.slice(1)),".inf"===t?1===i?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:".nan"===t?NaN:i*parseFloat(t,10)},predicate:function(e){return"[object Number]"===Object.prototype.toString.call(e)&&(e%1!=0||Ge.isNegativeZero(e))},represent:function(e,t){var i;if(isNaN(e))switch(t){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===e)switch(t){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===e)switch(t){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(Ge.isNegativeZero(e))return"-0.0";return i=e.toString(10),mt.test(i)?i.replace("e",".e"):i},defaultStyle:"lowercase"}),ft=at.extend({implicit:[st,ct,ut,gt]}),vt=ft,bt=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),yt=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");var xt=new Xe("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:function(e){return null!==e&&(null!==bt.exec(e)||null!==yt.exec(e))},construct:function(e){var t,i,r,o,n,a,s,c,l=0,d=null;if(null===(t=bt.exec(e))&&(t=yt.exec(e)),null===t)throw new Error("Date resolve error");if(i=+t[1],r=+t[2]-1,o=+t[3],!t[4])return new Date(Date.UTC(i,r,o));if(n=+t[4],a=+t[5],s=+t[6],t[7]){for(l=t[7].slice(0,3);l.length<3;)l+="0";l=+l}return t[9]&&(d=6e4*(60*+t[10]+ +(t[11]||0)),"-"===t[9]&&(d=-d)),c=new Date(Date.UTC(i,r,o,n,a,s,l)),d&&c.setTime(c.getTime()-d),c},instanceOf:Date,represent:function(e){return e.toISOString()}});var _t=new Xe("tag:yaml.org,2002:merge",{kind:"scalar",resolve:function(e){return"<<"===e||null===e}}),wt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=\n\r";var $t=new Xe("tag:yaml.org,2002:binary",{kind:"scalar",resolve:function(e){if(null===e)return!1;var t,i,r=0,o=e.length,n=wt;for(i=0;i<o;i++)if(!((t=n.indexOf(e.charAt(i)))>64)){if(t<0)return!1;r+=6}return r%8==0},construct:function(e){var t,i,r=e.replace(/[\r\n=]/g,""),o=r.length,n=wt,a=0,s=[];for(t=0;t<o;t++)t%4==0&&t&&(s.push(a>>16&255),s.push(a>>8&255),s.push(255&a)),a=a<<6|n.indexOf(r.charAt(t));return 0===(i=o%4*6)?(s.push(a>>16&255),s.push(a>>8&255),s.push(255&a)):18===i?(s.push(a>>10&255),s.push(a>>2&255)):12===i&&s.push(a>>4&255),new Uint8Array(s)},predicate:function(e){return"[object Uint8Array]"===Object.prototype.toString.call(e)},represent:function(e){var t,i,r="",o=0,n=e.length,a=wt;for(t=0;t<n;t++)t%3==0&&t&&(r+=a[o>>18&63],r+=a[o>>12&63],r+=a[o>>6&63],r+=a[63&o]),o=(o<<8)+e[t];return 0===(i=n%3)?(r+=a[o>>18&63],r+=a[o>>12&63],r+=a[o>>6&63],r+=a[63&o]):2===i?(r+=a[o>>10&63],r+=a[o>>4&63],r+=a[o<<2&63],r+=a[64]):1===i&&(r+=a[o>>2&63],r+=a[o<<4&63],r+=a[64],r+=a[64]),r}}),kt=Object.prototype.hasOwnProperty,Ct=Object.prototype.toString;var St=new Xe("tag:yaml.org,2002:omap",{kind:"sequence",resolve:function(e){if(null===e)return!0;var t,i,r,o,n,a=[],s=e;for(t=0,i=s.length;t<i;t+=1){if(r=s[t],n=!1,"[object Object]"!==Ct.call(r))return!1;for(o in r)if(kt.call(r,o)){if(n)return!1;n=!0}if(!n)return!1;if(-1!==a.indexOf(o))return!1;a.push(o)}return!0},construct:function(e){return null!==e?e:[]}}),At=Object.prototype.toString;var Mt=new Xe("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:function(e){if(null===e)return!0;var t,i,r,o,n,a=e;for(n=new Array(a.length),t=0,i=a.length;t<i;t+=1){if(r=a[t],"[object Object]"!==At.call(r))return!1;if(1!==(o=Object.keys(r)).length)return!1;n[t]=[o[0],r[o[0]]]}return!0},construct:function(e){if(null===e)return[];var t,i,r,o,n,a=e;for(n=new Array(a.length),t=0,i=a.length;t<i;t+=1)r=a[t],o=Object.keys(r),n[t]=[o[0],r[o[0]]];return n}}),zt=Object.prototype.hasOwnProperty;var Et=new Xe("tag:yaml.org,2002:set",{kind:"mapping",resolve:function(e){if(null===e)return!0;var t,i=e;for(t in i)if(zt.call(i,t)&&null!==i[t])return!1;return!0},construct:function(e){return null!==e?e:{}}}),It=vt.extend({implicit:[xt,_t],explicit:[$t,St,Mt,Et]}),Tt=Object.prototype.hasOwnProperty,Ot=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Pt=/[\x85\u2028\u2029]/,jt=/[,\[\]\{\}]/,Dt=/^(?:!|!!|![a-z\-]+!)$/i,Rt=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function Nt(e){return Object.prototype.toString.call(e)}function Lt(e){return 10===e||13===e}function Ht(e){return 9===e||32===e}function Ut(e){return 9===e||32===e||10===e||13===e}function Ft(e){return 44===e||91===e||93===e||123===e||125===e}function Bt(e){var t;return 48<=e&&e<=57?e-48:97<=(t=32|e)&&t<=102?t-97+10:-1}function Gt(e){return 120===e?2:117===e?4:85===e?8:0}function qt(e){return 48<=e&&e<=57?e-48:-1}function Qt(e){return 48===e?"\0":97===e?"":98===e?"\b":116===e||9===e?"\t":110===e?"\n":118===e?"\v":102===e?"\f":114===e?"\r":101===e?"":32===e?" ":34===e?'"':47===e?"/":92===e?"\\":78===e?"":95===e?" ":76===e?"\u2028":80===e?"\u2029":""}function Wt(e){return e<=65535?String.fromCharCode(e):String.fromCharCode(55296+(e-65536>>10),56320+(e-65536&1023))}function Yt(e,t,i){"__proto__"===t?Object.defineProperty(e,t,{configurable:!0,enumerable:!0,writable:!0,value:i}):e[t]=i}for(var Vt=new Array(256),Kt=new Array(256),Jt=0;Jt<256;Jt++)Vt[Jt]=Qt(Jt)?1:0,Kt[Jt]=Qt(Jt);function Zt(e,t){this.input=e,this.filename=t.filename||null,this.schema=t.schema||It,this.onWarning=t.onWarning||null,this.legacy=t.legacy||!1,this.json=t.json||!1,this.listener=t.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=e.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.firstTabInLine=-1,this.documents=[]}function Xt(e,t){var i={name:e.filename,buffer:e.input.slice(0,-1),position:e.position,line:e.line,column:e.position-e.lineStart};return i.snippet=Ke(i),new We(t,i)}function ei(e,t){throw Xt(e,t)}function ti(e,t){e.onWarning&&e.onWarning.call(null,Xt(e,t))}var ii={YAML:function(e,t,i){var r,o,n;null!==e.version&&ei(e,"duplication of %YAML directive"),1!==i.length&&ei(e,"YAML directive accepts exactly one argument"),null===(r=/^([0-9]+)\.([0-9]+)$/.exec(i[0]))&&ei(e,"ill-formed argument of the YAML directive"),o=parseInt(r[1],10),n=parseInt(r[2],10),1!==o&&ei(e,"unacceptable YAML version of the document"),e.version=i[0],e.checkLineBreaks=n<2,1!==n&&2!==n&&ti(e,"unsupported YAML version of the document")},TAG:function(e,t,i){var r,o;2!==i.length&&ei(e,"TAG directive accepts exactly two arguments"),r=i[0],o=i[1],Dt.test(r)||ei(e,"ill-formed tag handle (first argument) of the TAG directive"),Tt.call(e.tagMap,r)&&ei(e,'there is a previously declared suffix for "'+r+'" tag handle'),Rt.test(o)||ei(e,"ill-formed tag prefix (second argument) of the TAG directive");try{o=decodeURIComponent(o)}catch(t){ei(e,"tag prefix is malformed: "+o)}e.tagMap[r]=o}};function ri(e,t,i,r){var o,n,a,s;if(t<i){if(s=e.input.slice(t,i),r)for(o=0,n=s.length;o<n;o+=1)9===(a=s.charCodeAt(o))||32<=a&&a<=1114111||ei(e,"expected valid JSON character");else Ot.test(s)&&ei(e,"the stream contains non-printable characters");e.result+=s}}function oi(e,t,i,r){var o,n,a,s;for(Ge.isObject(i)||ei(e,"cannot merge mappings; the provided source object is unacceptable"),a=0,s=(o=Object.keys(i)).length;a<s;a+=1)n=o[a],Tt.call(t,n)||(Yt(t,n,i[n]),r[n]=!0)}function ni(e,t,i,r,o,n,a,s,c){var l,d;if(Array.isArray(o))for(l=0,d=(o=Array.prototype.slice.call(o)).length;l<d;l+=1)Array.isArray(o[l])&&ei(e,"nested arrays are not supported inside keys"),"object"==typeof o&&"[object Object]"===Nt(o[l])&&(o[l]="[object Object]");if("object"==typeof o&&"[object Object]"===Nt(o)&&(o="[object Object]"),o=String(o),null===t&&(t={}),"tag:yaml.org,2002:merge"===r)if(Array.isArray(n))for(l=0,d=n.length;l<d;l+=1)oi(e,t,n[l],i);else oi(e,t,n,i);else e.json||Tt.call(i,o)||!Tt.call(t,o)||(e.line=a||e.line,e.lineStart=s||e.lineStart,e.position=c||e.position,ei(e,"duplicated mapping key")),Yt(t,o,n),delete i[o];return t}function ai(e){var t;10===(t=e.input.charCodeAt(e.position))?e.position++:13===t?(e.position++,10===e.input.charCodeAt(e.position)&&e.position++):ei(e,"a line break is expected"),e.line+=1,e.lineStart=e.position,e.firstTabInLine=-1}function si(e,t,i){for(var r=0,o=e.input.charCodeAt(e.position);0!==o;){for(;Ht(o);)9===o&&-1===e.firstTabInLine&&(e.firstTabInLine=e.position),o=e.input.charCodeAt(++e.position);if(t&&35===o)do{o=e.input.charCodeAt(++e.position)}while(10!==o&&13!==o&&0!==o);if(!Lt(o))break;for(ai(e),o=e.input.charCodeAt(e.position),r++,e.lineIndent=0;32===o;)e.lineIndent++,o=e.input.charCodeAt(++e.position)}return-1!==i&&0!==r&&e.lineIndent<i&&ti(e,"deficient indentation"),r}function ci(e){var t,i=e.position;return!(45!==(t=e.input.charCodeAt(i))&&46!==t||t!==e.input.charCodeAt(i+1)||t!==e.input.charCodeAt(i+2)||(i+=3,0!==(t=e.input.charCodeAt(i))&&!Ut(t)))}function li(e,t){1===t?e.result+=" ":t>1&&(e.result+=Ge.repeat("\n",t-1))}function di(e,t){var i,r,o=e.tag,n=e.anchor,a=[],s=!1;if(-1!==e.firstTabInLine)return!1;for(null!==e.anchor&&(e.anchorMap[e.anchor]=a),r=e.input.charCodeAt(e.position);0!==r&&(-1!==e.firstTabInLine&&(e.position=e.firstTabInLine,ei(e,"tab characters must not be used in indentation")),45===r)&&Ut(e.input.charCodeAt(e.position+1));)if(s=!0,e.position++,si(e,!0,-1)&&e.lineIndent<=t)a.push(null),r=e.input.charCodeAt(e.position);else if(i=e.line,hi(e,t,3,!1,!0),a.push(e.result),si(e,!0,-1),r=e.input.charCodeAt(e.position),(e.line===i||e.lineIndent>t)&&0!==r)ei(e,"bad indentation of a sequence entry");else if(e.lineIndent<t)break;return!!s&&(e.tag=o,e.anchor=n,e.kind="sequence",e.result=a,!0)}function pi(e){var t,i,r,o,n=!1,a=!1;if(33!==(o=e.input.charCodeAt(e.position)))return!1;if(null!==e.tag&&ei(e,"duplication of a tag property"),60===(o=e.input.charCodeAt(++e.position))?(n=!0,o=e.input.charCodeAt(++e.position)):33===o?(a=!0,i="!!",o=e.input.charCodeAt(++e.position)):i="!",t=e.position,n){do{o=e.input.charCodeAt(++e.position)}while(0!==o&&62!==o);e.position<e.length?(r=e.input.slice(t,e.position),o=e.input.charCodeAt(++e.position)):ei(e,"unexpected end of the stream within a verbatim tag")}else{for(;0!==o&&!Ut(o);)33===o&&(a?ei(e,"tag suffix cannot contain exclamation marks"):(i=e.input.slice(t-1,e.position+1),Dt.test(i)||ei(e,"named tag handle cannot contain such characters"),a=!0,t=e.position+1)),o=e.input.charCodeAt(++e.position);r=e.input.slice(t,e.position),jt.test(r)&&ei(e,"tag suffix cannot contain flow indicator characters")}r&&!Rt.test(r)&&ei(e,"tag name cannot contain such characters: "+r);try{r=decodeURIComponent(r)}catch(t){ei(e,"tag name is malformed: "+r)}return n?e.tag=r:Tt.call(e.tagMap,i)?e.tag=e.tagMap[i]+r:"!"===i?e.tag="!"+r:"!!"===i?e.tag="tag:yaml.org,2002:"+r:ei(e,'undeclared tag handle "'+i+'"'),!0}function ui(e){var t,i;if(38!==(i=e.input.charCodeAt(e.position)))return!1;for(null!==e.anchor&&ei(e,"duplication of an anchor property"),i=e.input.charCodeAt(++e.position),t=e.position;0!==i&&!Ut(i)&&!Ft(i);)i=e.input.charCodeAt(++e.position);return e.position===t&&ei(e,"name of an anchor node must contain at least one character"),e.anchor=e.input.slice(t,e.position),!0}function hi(e,t,i,r,o){var n,a,s,c,l,d,p,u,h,m=1,g=!1,f=!1;if(null!==e.listener&&e.listener("open",e),e.tag=null,e.anchor=null,e.kind=null,e.result=null,n=a=s=4===i||3===i,r&&si(e,!0,-1)&&(g=!0,e.lineIndent>t?m=1:e.lineIndent===t?m=0:e.lineIndent<t&&(m=-1)),1===m)for(;pi(e)||ui(e);)si(e,!0,-1)?(g=!0,s=n,e.lineIndent>t?m=1:e.lineIndent===t?m=0:e.lineIndent<t&&(m=-1)):s=!1;if(s&&(s=g||o),1!==m&&4!==i||(u=1===i||2===i?t:t+1,h=e.position-e.lineStart,1===m?s&&(di(e,h)||function(e,t,i){var r,o,n,a,s,c,l,d=e.tag,p=e.anchor,u={},h=Object.create(null),m=null,g=null,f=null,v=!1,b=!1;if(-1!==e.firstTabInLine)return!1;for(null!==e.anchor&&(e.anchorMap[e.anchor]=u),l=e.input.charCodeAt(e.position);0!==l;){if(v||-1===e.firstTabInLine||(e.position=e.firstTabInLine,ei(e,"tab characters must not be used in indentation")),r=e.input.charCodeAt(e.position+1),n=e.line,63!==l&&58!==l||!Ut(r)){if(a=e.line,s=e.lineStart,c=e.position,!hi(e,i,2,!1,!0))break;if(e.line===n){for(l=e.input.charCodeAt(e.position);Ht(l);)l=e.input.charCodeAt(++e.position);if(58===l)Ut(l=e.input.charCodeAt(++e.position))||ei(e,"a whitespace character is expected after the key-value separator within a block mapping"),v&&(ni(e,u,h,m,g,null,a,s,c),m=g=f=null),b=!0,v=!1,o=!1,m=e.tag,g=e.result;else{if(!b)return e.tag=d,e.anchor=p,!0;ei(e,"can not read an implicit mapping pair; a colon is missed")}}else{if(!b)return e.tag=d,e.anchor=p,!0;ei(e,"can not read a block mapping entry; a multiline key may not be an implicit key")}}else 63===l?(v&&(ni(e,u,h,m,g,null,a,s,c),m=g=f=null),b=!0,v=!0,o=!0):v?(v=!1,o=!0):ei(e,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),e.position+=1,l=r;if((e.line===n||e.lineIndent>t)&&(v&&(a=e.line,s=e.lineStart,c=e.position),hi(e,t,4,!0,o)&&(v?g=e.result:f=e.result),v||(ni(e,u,h,m,g,f,a,s,c),m=g=f=null),si(e,!0,-1),l=e.input.charCodeAt(e.position)),(e.line===n||e.lineIndent>t)&&0!==l)ei(e,"bad indentation of a mapping entry");else if(e.lineIndent<t)break}return v&&ni(e,u,h,m,g,null,a,s,c),b&&(e.tag=d,e.anchor=p,e.kind="mapping",e.result=u),b}(e,h,u))||function(e,t){var i,r,o,n,a,s,c,l,d,p,u,h,m=!0,g=e.tag,f=e.anchor,v=Object.create(null);if(91===(h=e.input.charCodeAt(e.position)))a=93,l=!1,n=[];else{if(123!==h)return!1;a=125,l=!0,n={}}for(null!==e.anchor&&(e.anchorMap[e.anchor]=n),h=e.input.charCodeAt(++e.position);0!==h;){if(si(e,!0,t),(h=e.input.charCodeAt(e.position))===a)return e.position++,e.tag=g,e.anchor=f,e.kind=l?"mapping":"sequence",e.result=n,!0;m?44===h&&ei(e,"expected the node content, but found ','"):ei(e,"missed comma between flow collection entries"),u=null,s=c=!1,63===h&&Ut(e.input.charCodeAt(e.position+1))&&(s=c=!0,e.position++,si(e,!0,t)),i=e.line,r=e.lineStart,o=e.position,hi(e,t,1,!1,!0),p=e.tag,d=e.result,si(e,!0,t),h=e.input.charCodeAt(e.position),!c&&e.line!==i||58!==h||(s=!0,h=e.input.charCodeAt(++e.position),si(e,!0,t),hi(e,t,1,!1,!0),u=e.result),l?ni(e,n,v,p,d,u,i,r,o):s?n.push(ni(e,null,v,p,d,u,i,r,o)):n.push(d),si(e,!0,t),44===(h=e.input.charCodeAt(e.position))?(m=!0,h=e.input.charCodeAt(++e.position)):m=!1}ei(e,"unexpected end of the stream within a flow collection")}(e,u)?f=!0:(a&&function(e,t){var i,r,o,n,a=1,s=!1,c=!1,l=t,d=0,p=!1;if(124===(n=e.input.charCodeAt(e.position)))r=!1;else{if(62!==n)return!1;r=!0}for(e.kind="scalar",e.result="";0!==n;)if(43===(n=e.input.charCodeAt(++e.position))||45===n)1===a?a=43===n?3:2:ei(e,"repeat of a chomping mode identifier");else{if(!((o=qt(n))>=0))break;0===o?ei(e,"bad explicit indentation width of a block scalar; it cannot be less than one"):c?ei(e,"repeat of an indentation width identifier"):(l=t+o-1,c=!0)}if(Ht(n)){do{n=e.input.charCodeAt(++e.position)}while(Ht(n));if(35===n)do{n=e.input.charCodeAt(++e.position)}while(!Lt(n)&&0!==n)}for(;0!==n;){for(ai(e),e.lineIndent=0,n=e.input.charCodeAt(e.position);(!c||e.lineIndent<l)&&32===n;)e.lineIndent++,n=e.input.charCodeAt(++e.position);if(!c&&e.lineIndent>l&&(l=e.lineIndent),Lt(n))d++;else{if(e.lineIndent<l){3===a?e.result+=Ge.repeat("\n",s?1+d:d):1===a&&s&&(e.result+="\n");break}for(r?Ht(n)?(p=!0,e.result+=Ge.repeat("\n",s?1+d:d)):p?(p=!1,e.result+=Ge.repeat("\n",d+1)):0===d?s&&(e.result+=" "):e.result+=Ge.repeat("\n",d):e.result+=Ge.repeat("\n",s?1+d:d),s=!0,c=!0,d=0,i=e.position;!Lt(n)&&0!==n;)n=e.input.charCodeAt(++e.position);ri(e,i,e.position,!1)}}return!0}(e,u)||function(e,t){var i,r,o;if(39!==(i=e.input.charCodeAt(e.position)))return!1;for(e.kind="scalar",e.result="",e.position++,r=o=e.position;0!==(i=e.input.charCodeAt(e.position));)if(39===i){if(ri(e,r,e.position,!0),39!==(i=e.input.charCodeAt(++e.position)))return!0;r=e.position,e.position++,o=e.position}else Lt(i)?(ri(e,r,o,!0),li(e,si(e,!1,t)),r=o=e.position):e.position===e.lineStart&&ci(e)?ei(e,"unexpected end of the document within a single quoted scalar"):(e.position++,o=e.position);ei(e,"unexpected end of the stream within a single quoted scalar")}(e,u)||function(e,t){var i,r,o,n,a,s;if(34!==(s=e.input.charCodeAt(e.position)))return!1;for(e.kind="scalar",e.result="",e.position++,i=r=e.position;0!==(s=e.input.charCodeAt(e.position));){if(34===s)return ri(e,i,e.position,!0),e.position++,!0;if(92===s){if(ri(e,i,e.position,!0),Lt(s=e.input.charCodeAt(++e.position)))si(e,!1,t);else if(s<256&&Vt[s])e.result+=Kt[s],e.position++;else if((a=Gt(s))>0){for(o=a,n=0;o>0;o--)(a=Bt(s=e.input.charCodeAt(++e.position)))>=0?n=(n<<4)+a:ei(e,"expected hexadecimal character");e.result+=Wt(n),e.position++}else ei(e,"unknown escape sequence");i=r=e.position}else Lt(s)?(ri(e,i,r,!0),li(e,si(e,!1,t)),i=r=e.position):e.position===e.lineStart&&ci(e)?ei(e,"unexpected end of the document within a double quoted scalar"):(e.position++,r=e.position)}ei(e,"unexpected end of the stream within a double quoted scalar")}(e,u)?f=!0:!function(e){var t,i,r;if(42!==(r=e.input.charCodeAt(e.position)))return!1;for(r=e.input.charCodeAt(++e.position),t=e.position;0!==r&&!Ut(r)&&!Ft(r);)r=e.input.charCodeAt(++e.position);return e.position===t&&ei(e,"name of an alias node must contain at least one character"),i=e.input.slice(t,e.position),Tt.call(e.anchorMap,i)||ei(e,'unidentified alias "'+i+'"'),e.result=e.anchorMap[i],si(e,!0,-1),!0}(e)?function(e,t,i){var r,o,n,a,s,c,l,d,p=e.kind,u=e.result;if(Ut(d=e.input.charCodeAt(e.position))||Ft(d)||35===d||38===d||42===d||33===d||124===d||62===d||39===d||34===d||37===d||64===d||96===d)return!1;if((63===d||45===d)&&(Ut(r=e.input.charCodeAt(e.position+1))||i&&Ft(r)))return!1;for(e.kind="scalar",e.result="",o=n=e.position,a=!1;0!==d;){if(58===d){if(Ut(r=e.input.charCodeAt(e.position+1))||i&&Ft(r))break}else if(35===d){if(Ut(e.input.charCodeAt(e.position-1)))break}else{if(e.position===e.lineStart&&ci(e)||i&&Ft(d))break;if(Lt(d)){if(s=e.line,c=e.lineStart,l=e.lineIndent,si(e,!1,-1),e.lineIndent>=t){a=!0,d=e.input.charCodeAt(e.position);continue}e.position=n,e.line=s,e.lineStart=c,e.lineIndent=l;break}}a&&(ri(e,o,n,!1),li(e,e.line-s),o=n=e.position,a=!1),Ht(d)||(n=e.position+1),d=e.input.charCodeAt(++e.position)}return ri(e,o,n,!1),!!e.result||(e.kind=p,e.result=u,!1)}(e,u,1===i)&&(f=!0,null===e.tag&&(e.tag="?")):(f=!0,null===e.tag&&null===e.anchor||ei(e,"alias node should not have any properties")),null!==e.anchor&&(e.anchorMap[e.anchor]=e.result)):0===m&&(f=s&&di(e,h))),null===e.tag)null!==e.anchor&&(e.anchorMap[e.anchor]=e.result);else if("?"===e.tag){for(null!==e.result&&"scalar"!==e.kind&&ei(e,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+e.kind+'"'),c=0,l=e.implicitTypes.length;c<l;c+=1)if((p=e.implicitTypes[c]).resolve(e.result)){e.result=p.construct(e.result),e.tag=p.tag,null!==e.anchor&&(e.anchorMap[e.anchor]=e.result);break}}else if("!"!==e.tag){if(Tt.call(e.typeMap[e.kind||"fallback"],e.tag))p=e.typeMap[e.kind||"fallback"][e.tag];else for(p=null,c=0,l=(d=e.typeMap.multi[e.kind||"fallback"]).length;c<l;c+=1)if(e.tag.slice(0,d[c].tag.length)===d[c].tag){p=d[c];break}p||ei(e,"unknown tag !<"+e.tag+">"),null!==e.result&&p.kind!==e.kind&&ei(e,"unacceptable node kind for !<"+e.tag+'> tag; it should be "'+p.kind+'", not "'+e.kind+'"'),p.resolve(e.result,e.tag)?(e.result=p.construct(e.result,e.tag),null!==e.anchor&&(e.anchorMap[e.anchor]=e.result)):ei(e,"cannot resolve a node with !<"+e.tag+"> explicit tag")}return null!==e.listener&&e.listener("close",e),null!==e.tag||null!==e.anchor||f}function mi(e){var t,i,r,o,n=e.position,a=!1;for(e.version=null,e.checkLineBreaks=e.legacy,e.tagMap=Object.create(null),e.anchorMap=Object.create(null);0!==(o=e.input.charCodeAt(e.position))&&(si(e,!0,-1),o=e.input.charCodeAt(e.position),!(e.lineIndent>0||37!==o));){for(a=!0,o=e.input.charCodeAt(++e.position),t=e.position;0!==o&&!Ut(o);)o=e.input.charCodeAt(++e.position);for(r=[],(i=e.input.slice(t,e.position)).length<1&&ei(e,"directive name must not be less than one character in length");0!==o;){for(;Ht(o);)o=e.input.charCodeAt(++e.position);if(35===o){do{o=e.input.charCodeAt(++e.position)}while(0!==o&&!Lt(o));break}if(Lt(o))break;for(t=e.position;0!==o&&!Ut(o);)o=e.input.charCodeAt(++e.position);r.push(e.input.slice(t,e.position))}0!==o&&ai(e),Tt.call(ii,i)?ii[i](e,i,r):ti(e,'unknown document directive "'+i+'"')}si(e,!0,-1),0===e.lineIndent&&45===e.input.charCodeAt(e.position)&&45===e.input.charCodeAt(e.position+1)&&45===e.input.charCodeAt(e.position+2)?(e.position+=3,si(e,!0,-1)):a&&ei(e,"directives end mark is expected"),hi(e,e.lineIndent-1,4,!1,!0),si(e,!0,-1),e.checkLineBreaks&&Pt.test(e.input.slice(n,e.position))&&ti(e,"non-ASCII line breaks are interpreted as content"),e.documents.push(e.result),e.position===e.lineStart&&ci(e)?46===e.input.charCodeAt(e.position)&&(e.position+=3,si(e,!0,-1)):e.position<e.length-1&&ei(e,"end of the stream or a document separator is expected")}function gi(e,t){t=t||{},0!==(e=String(e)).length&&(10!==e.charCodeAt(e.length-1)&&13!==e.charCodeAt(e.length-1)&&(e+="\n"),65279===e.charCodeAt(0)&&(e=e.slice(1)));var i=new Zt(e,t),r=e.indexOf("\0");for(-1!==r&&(i.position=r,ei(i,"null byte is not allowed in input")),i.input+="\0";32===i.input.charCodeAt(i.position);)i.lineIndent+=1,i.position+=1;for(;i.position<i.length-1;)mi(i);return i.documents}var fi={loadAll:function(e,t,i){null!==t&&"object"==typeof t&&void 0===i&&(i=t,t=null);var r=gi(e,i);if("function"!=typeof t)return r;for(var o=0,n=r.length;o<n;o+=1)t(r[o])},load:function(e,t){var i=gi(e,t);if(0!==i.length){if(1===i.length)return i[0];throw new We("expected a single document in the stream, but found more")}}},vi=Object.prototype.toString,bi=Object.prototype.hasOwnProperty,yi=65279,xi={0:"\\0",7:"\\a",8:"\\b",9:"\\t",10:"\\n",11:"\\v",12:"\\f",13:"\\r",27:"\\e",34:'\\"',92:"\\\\",133:"\\N",160:"\\_",8232:"\\L",8233:"\\P"},_i=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],wi=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function $i(e){var t,i,r;if(t=e.toString(16).toUpperCase(),e<=255)i="x",r=2;else if(e<=65535)i="u",r=4;else{if(!(e<=4294967295))throw new We("code point within a string may not be greater than 0xFFFFFFFF");i="U",r=8}return"\\"+i+Ge.repeat("0",r-t.length)+t}function ki(e){this.schema=e.schema||It,this.indent=Math.max(1,e.indent||2),this.noArrayIndent=e.noArrayIndent||!1,this.skipInvalid=e.skipInvalid||!1,this.flowLevel=Ge.isNothing(e.flowLevel)?-1:e.flowLevel,this.styleMap=function(e,t){var i,r,o,n,a,s,c;if(null===t)return{};for(i={},o=0,n=(r=Object.keys(t)).length;o<n;o+=1)a=r[o],s=String(t[a]),"!!"===a.slice(0,2)&&(a="tag:yaml.org,2002:"+a.slice(2)),(c=e.compiledTypeMap.fallback[a])&&bi.call(c.styleAliases,s)&&(s=c.styleAliases[s]),i[a]=s;return i}(this.schema,e.styles||null),this.sortKeys=e.sortKeys||!1,this.lineWidth=e.lineWidth||80,this.noRefs=e.noRefs||!1,this.noCompatMode=e.noCompatMode||!1,this.condenseFlow=e.condenseFlow||!1,this.quotingType='"'===e.quotingType?2:1,this.forceQuotes=e.forceQuotes||!1,this.replacer="function"==typeof e.replacer?e.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function Ci(e,t){for(var i,r=Ge.repeat(" ",t),o=0,n=-1,a="",s=e.length;o<s;)-1===(n=e.indexOf("\n",o))?(i=e.slice(o),o=s):(i=e.slice(o,n+1),o=n+1),i.length&&"\n"!==i&&(a+=r),a+=i;return a}function Si(e,t){return"\n"+Ge.repeat(" ",e.indent*t)}function Ai(e){return 32===e||9===e}function Mi(e){return 32<=e&&e<=126||161<=e&&e<=55295&&8232!==e&&8233!==e||57344<=e&&e<=65533&&e!==yi||65536<=e&&e<=1114111}function zi(e){return Mi(e)&&e!==yi&&13!==e&&10!==e}function Ei(e,t,i){var r=zi(e),o=r&&!Ai(e);return(i?r:r&&44!==e&&91!==e&&93!==e&&123!==e&&125!==e)&&35!==e&&!(58===t&&!o)||zi(t)&&!Ai(t)&&35===e||58===t&&o}function Ii(e,t){var i,r=e.charCodeAt(t);return r>=55296&&r<=56319&&t+1<e.length&&(i=e.charCodeAt(t+1))>=56320&&i<=57343?1024*(r-55296)+i-56320+65536:r}function Ti(e){return/^\n* /.test(e)}function Oi(e,t,i,r,o,n,a,s){var c,l=0,d=null,p=!1,u=!1,h=-1!==r,m=-1,g=function(e){return Mi(e)&&e!==yi&&!Ai(e)&&45!==e&&63!==e&&58!==e&&44!==e&&91!==e&&93!==e&&123!==e&&125!==e&&35!==e&&38!==e&&42!==e&&33!==e&&124!==e&&61!==e&&62!==e&&39!==e&&34!==e&&37!==e&&64!==e&&96!==e}(Ii(e,0))&&function(e){return!Ai(e)&&58!==e}(Ii(e,e.length-1));if(t||a)for(c=0;c<e.length;l>=65536?c+=2:c++){if(!Mi(l=Ii(e,c)))return 5;g=g&&Ei(l,d,s),d=l}else{for(c=0;c<e.length;l>=65536?c+=2:c++){if(10===(l=Ii(e,c)))p=!0,h&&(u=u||c-m-1>r&&" "!==e[m+1],m=c);else if(!Mi(l))return 5;g=g&&Ei(l,d,s),d=l}u=u||h&&c-m-1>r&&" "!==e[m+1]}return p||u?i>9&&Ti(e)?5:a?2===n?5:2:u?4:3:!g||a||o(e)?2===n?5:2:1}function Pi(e,t,i,r,o){e.dump=function(){if(0===t.length)return 2===e.quotingType?'""':"''";if(!e.noCompatMode&&(-1!==_i.indexOf(t)||wi.test(t)))return 2===e.quotingType?'"'+t+'"':"'"+t+"'";var n=e.indent*Math.max(1,i),a=-1===e.lineWidth?-1:Math.max(Math.min(e.lineWidth,40),e.lineWidth-n),s=r||e.flowLevel>-1&&i>=e.flowLevel;switch(Oi(t,s,e.indent,a,function(t){return function(e,t){var i,r;for(i=0,r=e.implicitTypes.length;i<r;i+=1)if(e.implicitTypes[i].resolve(t))return!0;return!1}(e,t)},e.quotingType,e.forceQuotes&&!r,o)){case 1:return t;case 2:return"'"+t.replace(/'/g,"''")+"'";case 3:return"|"+ji(t,e.indent)+Di(Ci(t,n));case 4:return">"+ji(t,e.indent)+Di(Ci(function(e,t){var i,r,o=/(\n+)([^\n]*)/g,n=(s=e.indexOf("\n"),s=-1!==s?s:e.length,o.lastIndex=s,Ri(e.slice(0,s),t)),a="\n"===e[0]||" "===e[0];var s;for(;r=o.exec(e);){var c=r[1],l=r[2];i=" "===l[0],n+=c+(a||i||""===l?"":"\n")+Ri(l,t),a=i}return n}(t,a),n));case 5:return'"'+function(e){for(var t,i="",r=0,o=0;o<e.length;r>=65536?o+=2:o++)r=Ii(e,o),!(t=xi[r])&&Mi(r)?(i+=e[o],r>=65536&&(i+=e[o+1])):i+=t||$i(r);return i}(t)+'"';default:throw new We("impossible error: invalid scalar style")}}()}function ji(e,t){var i=Ti(e)?String(t):"",r="\n"===e[e.length-1];return i+(r&&("\n"===e[e.length-2]||"\n"===e)?"+":r?"":"-")+"\n"}function Di(e){return"\n"===e[e.length-1]?e.slice(0,-1):e}function Ri(e,t){if(""===e||" "===e[0])return e;for(var i,r,o=/ [^ ]/g,n=0,a=0,s=0,c="";i=o.exec(e);)(s=i.index)-n>t&&(r=a>n?a:s,c+="\n"+e.slice(n,r),n=r+1),a=s;return c+="\n",e.length-n>t&&a>n?c+=e.slice(n,a)+"\n"+e.slice(a+1):c+=e.slice(n),c.slice(1)}function Ni(e,t,i,r){var o,n,a,s="",c=e.tag;for(o=0,n=i.length;o<n;o+=1)a=i[o],e.replacer&&(a=e.replacer.call(i,String(o),a)),(Hi(e,t+1,a,!0,!0,!1,!0)||void 0===a&&Hi(e,t+1,null,!0,!0,!1,!0))&&(r&&""===s||(s+=Si(e,t)),e.dump&&10===e.dump.charCodeAt(0)?s+="-":s+="- ",s+=e.dump);e.tag=c,e.dump=s||"[]"}function Li(e,t,i){var r,o,n,a,s,c;for(n=0,a=(o=i?e.explicitTypes:e.implicitTypes).length;n<a;n+=1)if(((s=o[n]).instanceOf||s.predicate)&&(!s.instanceOf||"object"==typeof t&&t instanceof s.instanceOf)&&(!s.predicate||s.predicate(t))){if(i?s.multi&&s.representName?e.tag=s.representName(t):e.tag=s.tag:e.tag="?",s.represent){if(c=e.styleMap[s.tag]||s.defaultStyle,"[object Function]"===vi.call(s.represent))r=s.represent(t,c);else{if(!bi.call(s.represent,c))throw new We("!<"+s.tag+'> tag resolver accepts not "'+c+'" style');r=s.represent[c](t,c)}e.dump=r}return!0}return!1}function Hi(e,t,i,r,o,n,a){e.tag=null,e.dump=i,Li(e,i,!1)||Li(e,i,!0);var s,c=vi.call(e.dump),l=r;r&&(r=e.flowLevel<0||e.flowLevel>t);var d,p,u="[object Object]"===c||"[object Array]"===c;if(u&&(p=-1!==(d=e.duplicates.indexOf(i))),(null!==e.tag&&"?"!==e.tag||p||2!==e.indent&&t>0)&&(o=!1),p&&e.usedDuplicates[d])e.dump="*ref_"+d;else{if(u&&p&&!e.usedDuplicates[d]&&(e.usedDuplicates[d]=!0),"[object Object]"===c)r&&0!==Object.keys(e.dump).length?(!function(e,t,i,r){var o,n,a,s,c,l,d="",p=e.tag,u=Object.keys(i);if(!0===e.sortKeys)u.sort();else if("function"==typeof e.sortKeys)u.sort(e.sortKeys);else if(e.sortKeys)throw new We("sortKeys must be a boolean or a function");for(o=0,n=u.length;o<n;o+=1)l="",r&&""===d||(l+=Si(e,t)),s=i[a=u[o]],e.replacer&&(s=e.replacer.call(i,a,s)),Hi(e,t+1,a,!0,!0,!0)&&((c=null!==e.tag&&"?"!==e.tag||e.dump&&e.dump.length>1024)&&(e.dump&&10===e.dump.charCodeAt(0)?l+="?":l+="? "),l+=e.dump,c&&(l+=Si(e,t)),Hi(e,t+1,s,!0,c)&&(e.dump&&10===e.dump.charCodeAt(0)?l+=":":l+=": ",d+=l+=e.dump));e.tag=p,e.dump=d||"{}"}(e,t,e.dump,o),p&&(e.dump="&ref_"+d+e.dump)):(!function(e,t,i){var r,o,n,a,s,c="",l=e.tag,d=Object.keys(i);for(r=0,o=d.length;r<o;r+=1)s="",""!==c&&(s+=", "),e.condenseFlow&&(s+='"'),a=i[n=d[r]],e.replacer&&(a=e.replacer.call(i,n,a)),Hi(e,t,n,!1,!1)&&(e.dump.length>1024&&(s+="? "),s+=e.dump+(e.condenseFlow?'"':"")+":"+(e.condenseFlow?"":" "),Hi(e,t,a,!1,!1)&&(c+=s+=e.dump));e.tag=l,e.dump="{"+c+"}"}(e,t,e.dump),p&&(e.dump="&ref_"+d+" "+e.dump));else if("[object Array]"===c)r&&0!==e.dump.length?(e.noArrayIndent&&!a&&t>0?Ni(e,t-1,e.dump,o):Ni(e,t,e.dump,o),p&&(e.dump="&ref_"+d+e.dump)):(!function(e,t,i){var r,o,n,a="",s=e.tag;for(r=0,o=i.length;r<o;r+=1)n=i[r],e.replacer&&(n=e.replacer.call(i,String(r),n)),(Hi(e,t,n,!1,!1)||void 0===n&&Hi(e,t,null,!1,!1))&&(""!==a&&(a+=","+(e.condenseFlow?"":" ")),a+=e.dump);e.tag=s,e.dump="["+a+"]"}(e,t,e.dump),p&&(e.dump="&ref_"+d+" "+e.dump));else{if("[object String]"!==c){if("[object Undefined]"===c)return!1;if(e.skipInvalid)return!1;throw new We("unacceptable kind of an object to dump "+c)}"?"!==e.tag&&Pi(e,e.dump,t,n,l)}null!==e.tag&&"?"!==e.tag&&(s=encodeURI("!"===e.tag[0]?e.tag.slice(1):e.tag).replace(/!/g,"%21"),s="!"===e.tag[0]?"!"+s:"tag:yaml.org,2002:"===s.slice(0,18)?"!!"+s.slice(18):"!<"+s+">",e.dump=s+" "+e.dump)}return!0}function Ui(e,t){var i,r,o=[],n=[];for(Fi(e,o,n),i=0,r=n.length;i<r;i+=1)t.duplicates.push(o[n[i]]);t.usedDuplicates=new Array(r)}function Fi(e,t,i){var r,o,n;if(null!==e&&"object"==typeof e)if(-1!==(o=t.indexOf(e)))-1===i.indexOf(o)&&i.push(o);else if(t.push(e),Array.isArray(e))for(o=0,n=e.length;o<n;o+=1)Fi(e[o],t,i);else for(o=0,n=(r=Object.keys(e)).length;o<n;o+=1)Fi(e[r[o]],t,i)}function Bi(e,t){return function(){throw new Error("Function yaml."+e+" is removed in js-yaml 4. Use yaml."+t+" instead, which is now safe by default.")}}var Gi={Type:Xe,Schema:it,FAILSAFE_SCHEMA:at,JSON_SCHEMA:ft,CORE_SCHEMA:vt,DEFAULT_SCHEMA:It,load:fi.load,loadAll:fi.loadAll,dump:{dump:function(e,t){var i=new ki(t=t||{});i.noRefs||Ui(e,i);var r=e;return i.replacer&&(r=i.replacer.call({"":r},"",r)),Hi(i,0,r,!0,!0)?i.dump+"\n":""}}.dump,YAMLException:We,types:{binary:$t,float:gt,map:nt,null:st,pairs:Mt,set:Et,timestamp:xt,bool:ct,int:ut,merge:_t,omap:St,seq:ot,str:rt},safeLoad:Bi("safeLoad","load"),safeLoadAll:Bi("safeLoadAll","loadAll"),safeDump:Bi("safeDump","dump")};function qi(e){try{return Gi.dump(e,{indent:2,lineWidth:120,noRefs:!0,sortKeys:!1})}catch{return""}}function Qi(e){try{return Gi.load(e)}catch{return null}}class Wi{constructor(){this.suppressSync=!1}toYaml(e){const{type:t,...i}=e;return qi(i)}fromYaml(e,t){const i=Qi(e);return i?{...i,type:t.type}:null}isSuppressed(){return this.suppressSync}suppress(e){this.suppressSync=!0;try{e()}finally{this.suppressSync=!1}}}const Yi=c`
  :host {
    display: block;
  }
...
`;var tr=function(e,t,i,r){var o,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let ir=class extends he{constructor(){super(...arguments),this._searchQuery=""}render(){const e=this._searchQuery?_e.search(this._searchQuery):_e.getAll(),t=new Map;for(const r of i){const i=e.filter(e=>e.metadata.category===r).map(e=>e.metadata);i.length>0&&t.set(r,i)}return Y`
  ...
  `,mr([be({attribute:!1})],gr.prototype,"hass",void 0),mr([be({type:String})],gr.prototype,"value",void 0),mr([be({type:String})],gr.prototype,"label",void 0),mr([ye()],gr.prototype,"_showModal",void 0),mr([ye()],gr.prototype,"_searchQuery",void 0),mr([ye()],gr.prototype,"_selectedIcon",void 0),gr=mr([ge("mc-icon-picker")],gr);var fr=function(e,t,i,r){var o,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};const vr={general:{label:"General",icon:"mdi:cog"},actions:{label:"Actions",icon:"mdi:gesture-tap"},conditions:{label:"Conditions",icon:"mdi:filter-outline"},design:{label:"Design",icon:"mdi:palette"}};let br=class extends he{constructor(){super(...arguments),this.open=!1,this._activeTab="general"}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){if(!this.open||!this.module)return Y``;const e=_e.get(this.module.type);if(!e)return Y``;const t=e.getAvailableTabs(),i=t.includes(this._activeTab)?this._activeTab:t[0];return Y`
    ...
    `}_renderTabContent(e,t){if(!this.module||!this.onChange)return Y`<p>Loading...</p>`;const i=this.onChange;switch(e){case"general":return t.renderGeneralTab(this.module,this.hass,i);case"actions":return t.renderActionsTab?t.renderActionsTab(this.module,this.hass,i):Y`<p>No actions available</p>`;case"conditions":return t.renderConditionsTab?t.renderConditionsTab(this.module,this.hass,i):Y`<p>No conditions available</p>`;case"design":return t.renderDesignTab?t.renderDesignTab(this.module,this.hass,i):Y`<p>No design options</p>`}}};br.styles=[De,c`
    :host {
      display: block;
    }
  ...
  `,yr([be({type:String})],_r.prototype,"value",void 0),yr([ye()],_r.prototype,"_showModal",void 0),yr([ye()],_r.prototype,"_searchQuery",void 0),yr([ye()],_r.prototype,"_selectedCardType",void 0),_r=yr([ge("mc-card-picker")],_r);var wr=function(e,t,i,r){var o,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let $r=class extends he{constructor(){super(...arguments),this._showModuleSelector=!1,this._showSettingsModal=!1,this._showCardSettingsModal=!1,this._onAddModule=e=>{this._moduleSelectorTarget=e.detail,this._showModuleSelector=!0},this._onModuleSelected=e=>{this._moduleSelectorTarget&&this._stateManager.addModule(this._moduleSelectorTarget.rowIndex,this._moduleSelectorTarget.colIndex,e.detail.type),this._showModuleSelector=!1,this._moduleSelectorTarget=void 0}}connectedCallback(){super.connectedCallback(),this._stateManager=new Le(e=>{this.dispatchEvent(new CustomEvent("config-changed",{bubbles:!0,composed:!0,detail:{config:e}}))}),this._unsubscribe=this._stateManager.subscribe(e=>{this._editorState=e,void 0!==e.selectedPath?.moduleIndex&&(this._showSettingsModal=!0)}),this._pendingConfig&&(this._stateManager.setConfig(this._pendingConfig),this._pendingConfig=void 0)}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.(),this._stateManager?.destroy()}setConfig(e){this._stateManager?this._stateManager.setConfig(e):this._pendingConfig=e}render(){if(!this._editorState)return Y`<div class="mc-editor">Loading...</div>`;const{editorMode:e}=this._editorState;return Y`
      <div class="mc-editor">
    ...
    `}_renderModuleSelectorDialog(){return Y`
      ...
      ></mc-module-selector>
    `}};$r.styles=De,wr([be({attribute:!1})],$r.prototype,"hass",void 0),wr([be({attribute:!1})],$r.prototype,"lovelace",void 0),wr([ye()],$r.prototype,"_editorState",void 0),wr([ye()],$r.prototype,"_showModuleSelector",void 0),wr([ye()],$r.prototype,"_moduleSelectorTarget",void 0),wr([ye()],$r.prototype,"_showSettingsModal",void 0),wr([ye()],$r.prototype,"_showCardSettingsModal",void 0),$r=wr([ge(t)],$r);class kr{getAvailableTabs(){return["general","actions","conditions","design"]}validate(e){return[]}renderActionsTab(e,t,i){const r=e.actions,o=(t,o)=>{i({...e,actions:{...r,[t]:o}})};return Y`
      <div class="mc-tab-content">
  ...
  `}("Service",r.service,e=>t({...r,service:e}),i)}
    ...
    `}renderGeneralTab(e,t,i){const r=e;return Y`
      <div class="mc-tab-content">
        ...
        ${r.entity_picture?K:Me("Image URL",r.image,e=>i({...r,image:e}))}
    ...
    `}validate(e){const t=[],i=e;return i.image||i.entity_picture||t.push("An image URL or entity picture source is required"),i.entity_picture&&!i.entity&&t.push("Entity is required when using entity picture"),t}});_e.register(new class extends kr{constructor(){super(...arguments),this.metadata={type:"markdown",name:"Markdown",description:"Render markdown-formatted content",category:"content",icon:"mdi:language-markdown"}}createDefault(){return{id:Ce("markdown"),type:"markdown",content:"**Hello** _World_"}}renderPreview(e,t){const i=(e.content||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/__(.+?)__/g,"<strong>$1</strong>").replace(/\*(.+?)\*/g,"<em>$1</em>").replace(/_(.+?)_/g,"<em>$1</em>").replace(/`(.+?)`/g,"<code>$1</code>").replace(/\n/g,"<br>");return Y`
    ...
    `}renderGeneralTab(e,t,i){const r=e;return Y`
      <div class="mc-tab-content">
        ${Te("Camera Entity",r.entity,e=>i({...r,entity:e}),t)}
        ${Me("Aspect Ratio",r.aspect_ratio,e=>i({...r,aspect_ratio:e}))}
        ${Ie("Show Controls",r.show_controls,e=>i({...r,show_controls:e}))}
      </div>
    `}});_e.register(new class extends kr{constructor(){super(...arguments),this.metadata={type:"button",name:"Button",description:"Interactive button with icon, label, and optional state display",category:"controls",icon:"mdi:gesture-tap"}}createDefault(){return{id:Ce("button"),type:"button",label:"Button",icon:"mdi:power",show_state:!1,button_style:"default"}}renderPreview(e,t){const i=e,r=i.entity&&t?t.states[i.entity]:void 0,o=r?t.formatEntityState(r):void 0,n=i.label||"Button",a="icon-only"===i.button_style;return Y`
    ...
    `}validate(e){const t=[];return e.entity||t.push("Entity is required for light module"),t}});_e.register(new class extends kr{constructor(){super(...arguments),this.metadata={type:"gauge",name:"Gauge",description:"Arc gauge for displaying numeric sensor values",category:"controls",icon:"mdi:gauge"}}createDefault(){return{id:Ce("gauge"),type:"gauge",min:0,max:100,needle:!0,gauge_style:"half"}}renderPreview(e,t){const i=e,r=i.entity&&t?t.states[i.entity]:void 0,o=i.min??0,n=i.max??100,a=r?Number(r.state):Math.round((o+n)/2),s=Math.max(o,Math.min(n,a)),c=(s-o)/(n-o)*100,l=this._getSeverityColor(s,i.severity)||"var(--primary-color, #03a9f4)",d=("half"===i.gauge_style||i.gauge_style,"full"===i.gauge_style),p="quarter"===i.gauge_style;if(d){const e=c/100*360,t=(e-90)*(Math.PI/180),i=40,r=50,o=50+i*Math.cos(t),n=r+i*Math.sin(t);return Y`
      ...
      `}const u=c/100*180,h=(180+u)*(Math.PI/180),m=50+40*Math.cos(h),g=55+40*Math.sin(h);return Y`
    ...
    `}_getSeverityColor(e,t){if(t&&0!==t.length)for(const i of t)if(e>=i.from&&e<=i.to)return i.color}});_e.register(new class extends kr{constructor(){super(...arguments),this.metadata={type:"horizontal",name:"Horizontal",description:"Arrange child modules in a row",category:"layout",icon:"mdi:arrow-split-vertical"}}createDefault(){return{id:Ce("horizontal"),type:"horizontal",modules:[],gap:"8px",align:"center",justify:"start"}}renderPreview(e,t){const i=e,r=i.modules||[];return Y`
    ...
    `}});_e.register(new class extends kr{constructor(){super(...arguments),this.metadata={type:"tabs",name:"Tabs",description:"Tabbed container for groups of modules",category:"layout",icon:"mdi:tab"}}createDefault(){return{id:Ce("tabs"),type:"tabs",tabs:[{label:"Tab 1",modules:[]},{label:"Tab 2",modules:[]}],active_tab:0,tab_style:"default"}}renderPreview(e,t){const i=e,r=i.tabs||[],o=i.active_tab||0,n=r[o];return Y`
    ...
    `}});_e.register(new class extends kr{constructor(){super(...arguments),this.metadata={type:"separator",name:"Separator",description:"Visual divider between modules",category:"layout",icon:"mdi:minus"}}getAvailableTabs(){return["general","conditions","design"]}createDefault(){return{id:Ce("separator"),type:"separator",separator_style:"solid",separator_color:"var(--divider-color, #e5e7eb)",separator_width:"1px",direction:"horizontal"}}renderPreview(e,t){const i=e;return"vertical"===i.direction?Y`
    ...
    `:Y`
      ...
      `}renderGeneralTab(e,t,i){const r=e;return Y`
      <div class="mc-tab-content">
        ${Me("Video URL",r.url,e=>i({...r,url:e}))}
        ${Me("Poster Image URL",r.poster,e=>i({...r,poster:e}))}
        ${Ie("Autoplay",r.autoplay,e=>i({...r,autoplay:e}))}
        ${Ie("Loop",r.loop,e=>i({...r,loop:e}))}
        ${Ie("Muted",r.muted,e=>i({...r,muted:e}))}
      </div>
    `}});const{I:Cr}=de,Sr=2;class Ar{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const Mr=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),Mr(e,t);return!0},zr=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},Er=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),Or(t)}};function Ir(e){void 0!==this._$AN?(zr(this),this._$AM=e,Er(this)):this._$AM=e}function Tr(e,t=!1,i=0){const r=this._$AH,o=this._$AN;if(void 0!==o&&0!==o.size)if(t)if(Array.isArray(r))for(let e=i;e<r.length;e++)Mr(r[e],!1),zr(r[e]);else null!=r&&(Mr(r,!1),zr(r));else Mr(this,e)}const Or=e=>{e.type==Sr&&(e._$AP??=Tr,e._$AQ??=Ir)};class Pr extends Ar{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),Er(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Mr(this,e),zr(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}class jr{constructor(e){this.G=e}disconnect(){this.G=void 0}reconnect(e){this.G=e}deref(){return this.G}}class Dr{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise(e=>this.Z=e)}resume(){this.Z?.(),this.Y=this.Z=void 0}}const Rr=e=>!(e=>null===e||"object"!=typeof e&&"function"!=typeof e)(e)&&"function"==typeof e.then,Nr=1073741823;const Lr=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends Pr{constructor(){super(...arguments),this._$Cwt=Nr,this._$Cbt=[],this._$CK=new jr(this),this._$CX=new Dr}render(...e){return e.find(e=>!Rr(e))??V}update(e,t){const i=this._$Cbt;let r=i.length;this._$Cbt=t;const o=this._$CK,n=this._$CX;this.isConnected||this.disconnected();for(let e=0;e<t.length&&!(e>this._$Cwt);e++){const a=t[e];if(!Rr(a))return this._$Cwt=e,a;e<r&&a===i[e]||(this._$Cwt=Nr,r=0,Promise.resolve(a).then(async e=>{for(;n.get();)await n.get();const t=o.deref();if(void 0!==t){const i=t._$Cbt.indexOf(a);i>-1&&i<t._$Cwt&&(t._$Cwt=i,t.setValue(e))}}))}return V}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}});let Hr=null,Ur=null;async function Fr(){return Hr||(Ur||(Ur=window.loadCardHelpers()),Hr=await Ur,Hr)}_e.register(new class extends kr{constructor(){super(...arguments),this.metadata={type:"custom-card",name:"Custom Card",description:"Embed any 3rd party Lovelace card",category:"advanced",icon:"mdi:card-plus-outline"},this._elementCache=new Map,this._editorCache=new Map}getAvailableTabs(){return["general","conditions","design"]}createDefault(){return{id:Ce("custom-card"),type:"custom-card",name:"",card_type:"",card_config:{}}}renderPreview(e,t){const i=e;return i.card_type?Y`
      <div class="mc-module mc-custom-card">
        ${Lr(this._getOrCreateElement(i,t),Y`
          <div style="
  ...
  `}("Card Type",r.card_type,e=>{this._editorCache.delete(r.id),i({...r,card_type:e})})}
        ${r.card_type?Y`
            <div class="mc-card-editor-section">
              ...
              <div class="mc-card-editor-body">
                ${Lr(this._renderEditorContent(r,t,i),Y`<div class="mc-editor-loading">Loading editor...</div>`)}
              </div>
            </div>
          `:K}
      </div>
    ...
    `}async _renderEditorContent(e,t,i){const r=await this._getOrCreateEditor(e,t,i);if(r)return t&&(r.hass=t),Y`${r}`;const o=e.card_config_yaml??(e.card_config?qi(e.card_config):""),n=Qi(o);return Y`
      <div class="mc-yaml-fallback">
        ...
        <textarea
          .value=${o}
          @input=${t=>{const r=t.target.value,o=Qi(r);i(null!==o?{...e,card_config:o,card_config_yaml:r}:{...e,card_config_yaml:r})}}
          rows="12"
