...
`;var Qr=function(e,t,r,i){var o,n=arguments.length,a=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,r,i);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,r,a):o(t,r))||a);return n>3&&a&&Object.defineProperty(t,r,a),a};let Kr=class extends he{constructor(){super(...arguments),this._yaml="",this._error="",this._configSync=new Yr,this._suppressUpdate=!1}connectedCallback(){super.connectedCallback(),this.stateManager&&(this._unsubscribe=this.stateManager.subscribe(e=>{this._editorState=e,this._suppressUpdate||(this._yaml=this._configSync.toYaml(e.config),this._error="")}))}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.()}render(){return V`
    ...
    `}_onYamlInput(e){const t=e.target.value;this._yaml=t,this._suppressUpdate=!0;try{const e=this._configSync.fromYaml(t,this._editorState.config);e?(this._error="",this.stateManager.updateConfig(e)):this._error="Invalid YAML structure"}catch(e){this._error=e instanceof Error?e.message:"Parse error"}finally{this._suppressUpdate=!1}}};Kr.styles=[Me,Vr],Qr([be({attribute:!1})],Kr.prototype,"stateManager",void 0),Qr([be({attribute:!1})],Kr.prototype,"hass",void 0),Qr([ye()],Kr.prototype,"_yaml",void 0),Qr([ye()],Kr.prototype,"_error",void 0),Qr([ye()],Kr.prototype,"_editorState",void 0),Kr=Qr([fe("mc-yaml-editor")],Kr);const Jr=c`
  :host {
    display: block;
  }
...
`;var ti=function(e,t,r,i){var o,n=arguments.length,a=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,r,i);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,r,a):o(t,r))||a);return n>3&&a&&Object.defineProperty(t,r,a),a};let ri=class extends he{constructor(){super(...arguments),this._searchQuery=""}render(){const e=this._searchQuery?_e.search(this._searchQuery):_e.getAll(),t=new Map;for(const i of r){const r=e.filter(e=>e.metadata.category===i).map(e=>e.metadata);r.length>0&&t.set(i,r)}return V`
  ...
  `,mi([be({attribute:!1})],fi.prototype,"hass",void 0),mi([be({type:String})],fi.prototype,"value",void 0),mi([be({type:String})],fi.prototype,"label",void 0),mi([ye()],fi.prototype,"_showModal",void 0),mi([ye()],fi.prototype,"_searchQuery",void 0),mi([ye()],fi.prototype,"_selectedIcon",void 0),fi=mi([fe("mc-icon-picker")],fi);var gi=function(e,t,r,i){var o,n=arguments.length,a=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,r,i);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,r,a):o(t,r))||a);return n>3&&a&&Object.defineProperty(t,r,a),a};const vi={general:{label:"General",icon:"mdi:cog"},actions:{label:"Actions",icon:"mdi:gesture-tap"},conditions:{label:"Conditions",icon:"mdi:filter-outline"},design:{label:"Design",icon:"mdi:palette"}};let bi=class extends he{constructor(){super(...arguments),this.open=!1,this._activeTab="general"}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){if(!this.open||!this.module)return V``;const e=_e.get(this.module.type);if(!e)return V``;const t=e.getAvailableTabs(),r=t.includes(this._activeTab)?this._activeTab:t[0];return V`
    ...
    `}_renderTabContent(e,t){if(!this.module||!this.onChange)return V`<p>Loading...</p>`;const r=this.onChange;switch(e){case"general":return t.renderGeneralTab(this.module,this.hass,r);case"actions":return t.renderActionsTab?t.renderActionsTab(this.module,this.hass,r):V`<p>No actions available</p>`;case"conditions":return t.renderConditionsTab?t.renderConditionsTab(this.module,this.hass,r):V`<p>No conditions available</p>`;case"design":return t.renderDesignTab?t.renderDesignTab(this.module,this.hass,r):V`<p>No design options</p>`}}};bi.styles=[Me,c`
    :host {
      display: block;
    }
  ...
  `],gi([be({attribute:!1})],bi.prototype,"module",void 0),gi([be({attribute:!1})],bi.prototype,"hass",void 0),gi([be({type:Boolean})],bi.prototype,"open",void 0),gi([be({attribute:!1})],bi.prototype,"onChange",void 0),gi([ye()],bi.prototype,"_activeTab",void 0),bi=gi([fe("mc-settings-modal")],bi);var yi=function(e,t,r,i){var o,n=arguments.length,a=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,r,i);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,r,a):o(t,r))||a);return n>3&&a&&Object.defineProperty(t,r,a),a};let xi=class extends he{constructor(){super(...arguments),this._showModuleSelector=!1,this._showSettingsModal=!1,this._onAddModule=e=>{this._moduleSelectorTarget=e.detail,this._showModuleSelector=!0},this._onModuleSelected=e=>{this._moduleSelectorTarget&&this._stateManager.addModule(this._moduleSelectorTarget.rowIndex,this._moduleSelectorTarget.colIndex,e.detail.type),this._showModuleSelector=!1,this._moduleSelectorTarget=void 0}}connectedCallback(){super.connectedCallback(),this._stateManager=new Ie(e=>{this.dispatchEvent(new CustomEvent("config-changed",{bubbles:!0,composed:!0,detail:{config:e}}))}),this._unsubscribe=this._stateManager.subscribe(e=>{this._editorState=e,void 0!==e.selectedPath?.moduleIndex&&(this._showSettingsModal=!0)}),this._pendingConfig&&(this._stateManager.setConfig(this._pendingConfig),this._pendingConfig=void 0)}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.(),this._stateManager?.destroy()}setConfig(e){this._stateManager?this._stateManager.setConfig(e):this._pendingConfig=e}render(){if(!this._editorState)return V`<div class="mc-editor">Loading...</div>`;const{editorMode:e}=this._editorState;return V`
    ...
    `}renderConditionsTab(e,t,r){const i=e.display,o=i?.conditions||[],n=t=>{r({...e,display:{...i,...t}})},a=(e,t)=>{n({conditions:o.map(r=>r.id===e?{...r,...t}:r)})};return V`
      <div class="mc-tab-content">
  ...
  `}("Service",i.service,e=>t({...i,service:e}),r)}
    ...
    `}});_e.register(new class extends _i{constructor(){super(...arguments),this.metadata={type:"button",name:"Button",description:"Interactive button with icon, label, and optional state display",category:"controls",icon:"mdi:gesture-tap"}}createDefault(){return{id:Ce("button"),type:"button",label:"Button",icon:"mdi:power",show_state:!1,button_style:"default"}}renderPreview(e,t){const r=e,i=r.entity&&t?t.states[r.entity]:void 0,o=i?t.formatEntityState(i):void 0,n=r.label||"Button",a="icon-only"===r.button_style;return V`
    ...
    `}_getSeverityColor(e,t){if(t&&0!==t.length)for(const r of t)if(e>=r.from&&e<=r.to)return r.color}});_e.register(new class extends _i{constructor(){super(...arguments),this.metadata={type:"horizontal",name:"Horizontal",description:"Arrange child modules in a row",category:"layout",icon:"mdi:arrow-split-vertical"}}createDefault(){return{id:Ce("horizontal"),type:"horizontal",modules:[],gap:"8px",align:"center",justify:"start"}}renderPreview(e,t){const r=e,i=r.modules||[];return V`
    ...
    `}});_e.register(new class extends _i{constructor(){super(...arguments),this.metadata={type:"tabs",name:"Tabs",description:"Tabbed container for groups of modules",category:"layout",icon:"mdi:tab"}}createDefault(){return{id:Ce("tabs"),type:"tabs",tabs:[{label:"Tab 1",modules:[]},{label:"Tab 2",modules:[]}],active_tab:0,tab_style:"default"}}renderPreview(e,t){const r=e,i=r.tabs||[],o=r.active_tab||0,n=i[o];return V`
    ...
    `}});_e.register(new class extends _i{constructor(){super(...arguments),this.metadata={type:"separator",name:"Separator",description:"Visual divider between modules",category:"layout",icon:"mdi:minus"}}getAvailableTabs(){return["general","conditions","design"]}createDefault(){return{id:Ce("separator"),type:"separator",separator_style:"solid",separator_color:"var(--divider-color, #e5e7eb)",separator_width:"1px",direction:"horizontal"}}renderPreview(e,t){const r=e;return"vertical"===r.direction?V`
    ...
    `}});_e.register(new class extends _i{constructor(){super(...arguments),this.metadata={type:"video-bg",name:"Video Background",description:"Display a video as a background",category:"advanced",icon:"mdi:video-outline"}}getAvailableTabs(){return["general","conditions","design"]}createDefault(){return{id:Ce("video-bg"),type:"video-bg",autoplay:!0,loop:!0,muted:!0}}renderPreview(e,t){const r=e;return r.url?V`
    ...
    `:V`
      ...
      `}async _getOrCreateElement(e,t){const r=this._elementCache.get(e.id),i=(o=e.card_type,n=e.card_config,JSON.stringify({t:o,c:n}));var o,n;let a;if(r&&r.cardType===e.card_type){if(a=r.element,r.hash!==i)try{const t={type:e.card_type,...e.card_config||{}};a.setConfig(t),r.hash=i}catch(e){return V`<div style="color: var(--error-color, #ef4444); padding: 12px; font-size: 0.875rem;">
          ...
          </div>`}}else try{const t=await Li(),r={type:e.card_type,...e.card_config||{}};a=t.createCardElement(r),this._elementCache.set(e.id,{element:a,cardType:e.card_type,hash:i})}catch(t){return V`<div style="color: var(--error-color, #ef4444); padding: 12px; font-size: 0.875rem;">
      ...
      <div class="mc-configure-modal-overlay" @click=${i}>
        <div class="mc-configure-modal" @click=${e=>e.stopPropagation()}>
          ...
          <div class="mc-configure-modal-body">
            ${Pi(this._renderEditorContent(e,t,r),V`<div class="mc-editor-loading">Loading editor...</div>`)}
          </div>
    ...
    `}async _renderEditorContent(e,t,r){const i=await this._getOrCreateEditor(e,t,r);if(i)return t&&(i.hass=t),V`${i}`;const o=e.card_config_yaml??(e.card_config?Gr(e.card_config):""),n=Wr(o);return V`
