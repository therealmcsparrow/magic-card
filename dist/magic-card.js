...
`;var ir=function(e,t,i,r){var o,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let rr=class extends me{constructor(){super(...arguments),this._searchQuery=""}render(){const e=this._searchQuery?_e.search(this._searchQuery):_e.getAll(),t=new Map;for(const r of i){const i=e.filter(e=>e.metadata.category===r).map(e=>e.metadata);i.length>0&&t.set(r,i)}return Y`
  ...
  `,wr([be({type:String})],kr.prototype,"value",void 0),wr([ye()],kr.prototype,"_showModal",void 0),wr([ye()],kr.prototype,"_searchQuery",void 0),wr([ye()],kr.prototype,"_selectedCardType",void 0),kr=wr([ge("mc-card-picker")],kr);var Cr=function(e,t,i,r){var o,n=arguments.length,a=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(n<3?o(a):n>3?o(t,i,a):o(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};let Sr=class extends me{constructor(){super(...arguments),this._showModuleSelector=!1,this._showSettingsModal=!1,this._showCardSettingsModal=!1,this._onAddModule=e=>{this._moduleSelectorTarget=e.detail,this._showModuleSelector=!0},this._onModuleSelected=e=>{this._moduleSelectorTarget&&this._stateManager.addModule(this._moduleSelectorTarget.rowIndex,this._moduleSelectorTarget.colIndex,e.detail.type),this._showModuleSelector=!1,this._moduleSelectorTarget=void 0}}connectedCallback(){super.connectedCallback(),this._stateManager=new He(e=>{this.dispatchEvent(new CustomEvent("config-changed",{bubbles:!0,composed:!0,detail:{config:e}}))}),this._unsubscribe=this._stateManager.subscribe(e=>{this._editorState=e,void 0!==e.selectedPath?.moduleIndex&&(this._showSettingsModal=!0)}),this._pendingConfig&&(this._stateManager.setConfig(this._pendingConfig),this._pendingConfig=void 0)}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.(),this._stateManager?.destroy()}setConfig(e){this._stateManager?this._stateManager.setConfig(e):this._pendingConfig=e}render(){if(!this._editorState)return Y`<div class="mc-editor">Loading...</div>`;const{editorMode:e}=this._editorState;return Y`
    ...
    `}renderConditionsTab(e,t,i){const r=e.display,o=r?.conditions||[],n=t=>{i({...e,display:{...r,...t}})},a=(e,t)=>{n({conditions:o.map(i=>i.id===e?{...i,...t}:i)})};return Y`
      <div class="mc-tab-content">
        ${Ee("Condition Mode",r?.mode||"every",[{label:"All conditions (AND)",value:"every"},{label:"Any condition (OR)",value:"any"}],e=>n({mode:e}))}

        <div class="mc-conditions-list">
          ${o.map(e=>Y`
              <div class="mc-condition-item">
                ${Ee("Type",e.type,[{label:"State",value:"state"},{label:"Attribute",value:"attribute"},{label:"Time",value:"time"},{label:"Template",value:"template"}],t=>a(e.id,{type:t}))}
  ...
  `}("Service",r.service,e=>t({...r,service:e}),i)}
    ...
    `}});_e.register(new class extends Ar{constructor(){super(...arguments),this.metadata={type:"slider",name:"Slider",description:"Range slider for controlling numeric values",category:"controls",icon:"mdi:tune-vertical"}}createDefault(){return{id:Ce("slider"),type:"slider",show_value:!0,direction:"horizontal"}}_getEntityLimits(e,t){if(!e)return{min:0,max:100,step:1};const i=e.entity_id.split(".")[0],r=e.attributes;switch(i){case"input_number":case"number":default:return{min:Number(r.min??0),max:Number(r.max??100),step:Number(r.step??1)};case"light":return"color_temp"===t?{min:Number(r.min_mireds??153),max:Number(r.max_mireds??500),step:1}:{min:0,max:100,step:1};case"fan":return{min:0,max:100,step:Number(r.percentage_step??1)};case"cover":case"media_player":return{min:0,max:100,step:1};case"climate":return{min:Number(r.min_temp??7),max:Number(r.max_temp??35),step:Number(r.target_temp_step??.5)}}}_createSliderHandler(e,t,i,r){const o="vertical"===i.direction,{min:n,max:a,step:s}=r;return r=>{r.stopPropagation();const c=r.currentTarget;c.setPointerCapture(r.pointerId);const l=e=>{const t=c.getBoundingClientRect();return o?Math.max(0,Math.min(1,1-(e.clientY-t.top)/t.height)):Math.max(0,Math.min(1,(e.clientX-t.left)/t.width))};c.style.setProperty("--slider-value",String(l(r)));const d=e=>{c.style.setProperty("--slider-value",String(l(e)))},p=r=>{c.removeEventListener("pointermove",d),c.removeEventListener("pointerup",p);const o=l(r),u=n+o*(a-n),m=Math.round(u/s)*s;this._callEntityService(e,t,m,i.attribute)};c.addEventListener("pointermove",d),c.addEventListener("pointerup",p)}}_callEntityService(e,t,i,r){const o=t.split(".")[0];switch(o){case"input_number":case"number":default:e.callService(o,"set_value",{entity_id:t,value:i});break;case"light":r&&"brightness"!==r?"color_temp"===r&&e.callService("light","turn_on",{entity_id:t,color_temp:Math.round(i)}):e.callService("light","turn_on",{entity_id:t,brightness_pct:Math.round(i)});break;case"fan":e.callService("fan","set_percentage",{entity_id:t,percentage:Math.round(i)});break;case"cover":e.callService("cover","set_cover_position",{entity_id:t,position:Math.round(i)});break;case"media_player":e.callService("media_player","volume_set",{entity_id:t,volume_level:i/100});break;case"climate":e.callService("climate","set_temperature",{entity_id:t,temperature:i})}}renderPreview(e,t){const i=e,r=i.entity&&t?t.states[i.entity]:void 0,{min:o,max:n}=this._getEntityLimits(r,i.attribute),a=r?i.attribute?Number(r.attributes[i.attribute]??o):Number(r.state):Math.round((o+n)/2),s="vertical"===i.direction,c=n>o?(a-o)/(n-o):0,l=this._getEntityLimits(r,i.attribute),d=i.entity&&t?this._createSliderHandler(t,i.entity,i,l):void 0;return Y`
      <div
